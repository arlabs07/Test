...
let pagesDataIframe = [
  ...
  },
  {
    ...
    "category": "Fmm ",
    "order": "10",
    "content": "<h2>Investment Basics</h2>\n<h3>What is Investment?</h3>\n<ul>\n<li>Using savings to get returns in the future</li>\n</ul>\n<h3>Why Invest?</h3>\n<ul>\n<li>To earn returns on resources</li>\n<li>To generate a specified sum of money for the future</li>\n<li>To protect against uncertain future events</li>\n</ul>\n<h3>Inflation</h3>\n<ul>\n<li>The rate at which the cost of living increases</li>\n</ul>\n<h3>When to Invest?</h3>\n<ul>\n<li>Invest early</li>\n<li>Invest regularly</li>\n<li>Invest for the long term</li>\n</ul>\n<h3>Care to be Taken While Investing</h3>\n<ul>\n<li>Obtain written documents</li>\n<li>Read and understand the documents</li>\n<li>Verify the lawfulness of the investment</li>\n<li>Find the cost and benefits</li>\n<li>Assess the risk-return profile</li>\n<li>Know the liquidity</li>\n<li>Conduct comparative study of investments</li>\n<li>Deal through an authorized intermediary</li>\n<li>Ascertain if it is appropriate for your specified goal</li>\n</ul>\n<h3>Interest</h3>\n<ul>\n<li>Amount charged to the borrower for the privilege of using lender&#39;s money</li>\n<li>Usually calculated as a percentage of the principal amount</li>\n</ul>\n<h3>Short Term Investments</h3>\n<h4>Savings Bank Account</h4>\n<ul>\n<li>First banking product people use</li>\n<li>Offers low interest: 4-5%</li>\n</ul>\n<h4>Money Market or Liquid Funds</h4>\n<ul>\n<li>Specialized form of mutual fund</li>\n<li>Fixed income instrument</li>\n<li>Provides easy liquidity</li>\n<li>Gives better returns than savings account</li>\n</ul>\n<h4>Fixed Deposit with Bank</h4>\n<ul>\n<li>Also referred as term deposit</li>\n<li>Minimum investment period: 30 days</li>\n<li>For low risk appetite investors</li>\n</ul>\n<h3>Long Term Financial Options</h3>\n<h4>Post Office Savings</h4>\n<ul>\n<li>Low risk saving instrument</li>\n<li>Can be availed from any post office</li>\n<li>Interest rate: 8% per annum (simple interest)</li>\n<li>Minimum amount: ₹1,000</li>\n<li>Maximum amount: ₹3 lakh</li>\n<li>Maturity period: 6 years</li>\n<li>10% bonus on completion</li>\n<li>5% deduction if withdrawn prematurely</li>\n</ul>\n<h4>Public Provident Fund (PPF)</h4>\n<ul>\n<li>Long term savings instrument</li>\n<li>Maturity period: 15 years</li>\n<li>Interest: 8% per annum (compounded)</li>\n<li>Can be opened through any nationalized bank</li>\n<li>Tax benefits can be availed</li>\n</ul>\n<h4>Company Fixed Deposit</h4>\n<ul>\n<li>Borrowing by company for short to medium term</li>\n<li>Fixed rate of interest (ROI)</li>\n<li>Interest varies from company to company: 6-9%</li>\n<li>Interest received after tax deductions</li>\n</ul>\n<h4>Bonds</h4>\n<ul>\n<li>Debt instrument</li>\n<li>Promise to repay the principal along with fixed ROI on a specified date (maturity date)</li>\n<li>Purpose: Raising capital</li>\n<li>Issued by central or state government</li>\n</ul>\n<h4>Mutual Funds</h4>\n<ul>\n<li>Operated by investment company</li>\n<li>Raise money from public and invest in group of assets</li>\n<li>Substitute for those who lack time, knowledge, and resources about investment</li>\n</ul>\n<h4>Net Asset Value (NAV)</h4>\n<ul>\n<li>Formula: (Value of all shares - Expenses) / Number of units issued</li>\n</ul>\n<h3>Stock Exchange</h3>\n<h4>Definition (SCRA 1956)</h4>\n<ul>\n<li>The Securities Contract Regulation Act 1956 (SCRA) defines stock exchange as any body of individuals, whether incorporated or not, constituted for the purpose of assisting, regulating, or controlling the business of buying, selling, or dealing in securities</li>\n</ul>\n<h4>Types</h4>\n<ul>\n<li>Original Stock Exchange</li>\n<li>National Stock Exchange (NSE)</li>\n<li>NSE is incorporated as National Stock Exchange</li>\n</ul>\n<h3>Types of Securities</h3>\n<h4>Equity</h4>\n<ul>\n<li>Total capital equity of a company is divided into equal units of small denomination, each called a share</li>\n<li>Holders of equity are members of the company</li>\n<li>Have voting rights</li>\n</ul>\n<h4>Debt Instrument</h4>\n<ul>\n<li>Contract where one party lends money to another party for predetermined terms</li>\n<li>Terms include: Rate, period of interest, repayment of principal amount</li>\n<li>Two types:<ul>\n<li>Bonds: Issued by central or state government</li>\n<li>Debentures: Issued by private corporate sectors</li>\n</ul>\n</li>\n</ul>\n<h4>Derivative</h4>\n<ul>\n<li>Financial contracts between two or more parties</li>\n<li>Derive their value from underlying asset, group of assets, or a benchmark</li>\n<li>Can trade on an exchange or over the counter</li>\n<li>Prices for derivatives derive from fluctuations in market price of underlying asset</li>\n</ul>\n<h4>Underlying Asset</h4>\n<ul>\n<li>The financial instrument (stock, bond, commodity, or currency) that a derivative contract or investment product is based on</li>\n</ul>\n<h4>Index</h4>\n<ul>\n<li>Basket of securities</li>\n<li>Tracks price and movement of the basket of securities</li>\n<li>Indicates the index movement</li>\n<li>Example: Nifty is the index of National Stock Exchange</li>\n</ul>\n<hr>\n<h2>Securities</h2>\n<h3>What are Securities?</h3>\n<ul>\n<li>Under the Securities Contract Regulation Act 1956, securities are defined as a broad category of instruments that includes:<ul>\n<li>Scrips</li>\n<li>Stocks</li>\n<li>Shares</li>\n<li>Bonds</li>\n<li>Debentures</li>\n</ul>\n</li>\n</ul>\n<h3>Functions of Stock Market</h3>\n<ul>\n<li>Facilitates capital formation for companies</li>\n<li>Provides liquidity to investors</li>\n<li>Enables price discovery through demand and supply</li>\n<li>Offers investment opportunities for wealth creation</li>\n<li>Ensures transparent and regulated trading environment</li>\n</ul>\n<h3>Investment Options</h3>\n<p>One can invest in:</p>\n<ul>\n<li>Shares</li>\n<li>Derivative products</li>\n<li>Units of mutual funds</li>\n<li>Government securities</li>\n</ul>\n<h3>Regulators</h3>\n<h4>What is a Regulator?</h4>\n<ul>\n<li>Official body or organization responsible for:<ul>\n<li>Overseeing operations</li>\n<li>Monitoring activities</li>\n<li>Enforcing rules and regulations</li>\n<li>Ensuring fair and efficient operations</li>\n<li>Protecting investors&#39; interests</li>\n</ul>\n</li>\n<li>Acts as the guardian promoting transparency, preventing fraud, and ensuring compliance</li>\n</ul>\n<h4>Need for Regulators</h4>\n<ul>\n<li>To ensure proper behavior of market participants</li>\n<li>To protect the interest of investors</li>\n<li>To regulate the securities market</li>\n</ul>\n<h4>Who Regulates the Securities Market?</h4>\n<ul>\n<li>Department of Economic Affairs (DEA)</li>\n<li>Department of Company Affairs (DCA)</li>\n<li>Reserve Bank of India (RBI)</li>\n<li>Securities and Exchange Board of India (SEBI)</li>\n</ul>\n<h3>SEBI (Securities and Exchange Board of India)</h3>\n<h4>Establishment</h4>\n<ul>\n<li>Established under Section 3 of SEBI Act 1992</li>\n<li>Statutory regulatory body established by the Indian government to:<ul>\n<li>Regulate the securities market</li>\n<li>Protect investors&#39; interests</li>\n</ul>\n</li>\n</ul>\n<h4>Role of SEBI</h4>\n<ul>\n<li>To protect the interest of investors</li>\n<li>To promote development of securities market</li>\n<li>To regulate the securities market</li>\n</ul>\n<h4>Powers of SEBI</h4>\n<ul>\n<li>Regulate the business in stock exchanges</li>\n<li>Register and regulate the work of:<ul>\n<li>Stock brokers</li>\n<li>Sub-brokers</li>\n<li>Other intermediaries</li>\n</ul>\n</li>\n<li>Promote and regulate self-regulatory organizations</li>\n<li>Prohibit fraudulent and unfair trade practices</li>\n</ul>\n<h3>Participants in Securities Market</h3>\n<ul>\n<li>Issuers of securities</li>\n<li>Investors in securities</li>\n<li>Intermediaries such as merchant bankers, stock brokers, etc.</li>\n</ul>\n<h3>Necessity of an Intermediary</h3>\n<h4>SEBI Regulations</h4>\n<ul>\n<li>SEBI mandates all transactions on stock exchanges must be executed through registered members</li>\n</ul>\n<h4>Role of Intermediary</h4>\n<ul>\n<li>Intermediaries like stock brokers act as a link between investors and stock exchange</li>\n<li>They facilitate the buying and selling of securities</li>\n<li>Individuals cannot directly place orders on the stock exchange</li>\n<li>All orders must be placed through a registered stock broker</li>\n<li>SEBI regulates and monitors the activities of intermediaries to ensure fair and transparent trading practices</li>\n</ul>\n<h3>Segments of Securities Market</h3>\n<p>The securities market has two interdependent segments:</p>\n<h4>Primary Market</h4>\n<ul>\n<li>Provides the channel for the sale of new securities</li>\n</ul>\n<h4>Secondary Market</h4>\n<ul>\n<li>Deals with previously issued shares</li>\n</ul>\n<hr>\n\n\n<h2>Derivatives</h2>\n<ul><li>Derivatives are financial contracts and their value is determined by the value of an underlying asset, stocks, bonds, currencies, commodities, and market indices.</li></ul>\n<h3>Types of Derivatives</h3>\n<strong>(i) Forward Derivatives :</strong>\n<ul><li>Forward contracts are customized contracts between two entities. The settlement of forward takes place on a specific date in the future at pre-agreed.</li><li>Forwards are like future contracts wherein the holder is under an obligation to perform the contract.</li><li>These contracts are available over the counter and are not marked to market.</li></ul>\n<strong>(ii) Future Derivatives:</strong>\n<ul><li>They are standardized contracts that allow the holder to buy and sell the asset at an agreed price at the specific date.</li><li>The parties are under an obligation to perform the contract.</li><li>The stock exchange, the value of such future contracts is marked to the market every day.</li></ul>\n<strong>(iii)Options Derivatives:</strong>\n<ul><li>They are contracts that give the buyer a right to buy or sell the underlying asset at a specified price during a particular period of time.</li><li>The buyer or seller is not under an obligation to perform the contract/option.</li><li>The writer of an option is the one who receives option premium and therefore is obliged to sell/buy, if the buyer/seller exercises on him.</li></ul>\n<em>There are 2 types of option:</em>\n<strong>Call Option:</strong>\n<ul><li>Gives the buyer’s right but not the obligation to buy a given quantity of underlying asset at a given price on or before future date.</li></ul>\n<strong>Put Option:</strong>\n<ul><li>Gives the seller the right but not obligation to sell a given quantity of underlying asset at a given price on or before given future date.</li></ul>\n<ul><li>Presently at NSE, future and options are traded on the Nifty, CNXIT, Bank Nifty and 116 single stocks.</li></ul>\n<strong>Warrants :</strong>\n<ul><li>The majority of options traded on exchanges have a maximum maturity of 9 months. Longer dated options are called warrants and are generally traded over-the-counter.</li></ul>\n<strong>Option Premium:</strong>\n<ul><li>At the time of buying an option contract, the buyer has to pay premium.</li><li>It is the price for acquiring the right to buy or sell.</li><li>It is a price paid by the option buyer to the option seller for acquiring the right to buy or sell.</li><li>Option premiums are always paid upfront.</li></ul>\n<strong>Commodity :</strong>\n<ul><li>The Forward Contract Regulation Act, 1952 defines a &quot;commodity&quot; broadly as any tangible goods, products or materials that can be bought or sold.</li><li>Future trading is organized in such goods or commodity as are permitted by the Central Government.</li></ul>\n<strong>Commodity Exchange</strong>\n<ul><li>A commodity exchange is a regulated marketplace where standardized raw materials like agricultural products, metals and energy are traded.</li><li>In India, major commodity exchanges include:</li><li>Multi Commodity Exchange (MCX)</li><li>National Commodity and Derivatives Exchange (NCDEX)</li></ul>\n<strong>Difference between Future and Option Derivatives</strong>\n<table><thead><tr><th>Future derivatives</th><th>option derivatives</th></tr></thead><tbody><tr><td>A future contract is an agreement between 2 parties to buy or sell an asset at a certain time in the future at certain price.</td><td>Right but not the obligation to buy or sell the underlying asset at or before a certain date.</td></tr><tr><td>Higher in risk due to the obligation to execute the contract.</td><td>Limited risk due to the non-binding nature of the contract.</td></tr><tr><td>Margin required as a security deposit.</td><td>Option premium paid in advance.</td></tr><tr><td>Unlimited profit or loss potential.</td><td>Unlimited profit &amp; limited loss potential.</td></tr></tbody></table>\n<strong>Difference between Commodity &amp; Financial Derivatives</strong>\n<table><thead><tr><th>Financial Derivatives</th><th>Commodity Derivatives</th></tr></thead><tbody><tr><td>In a financial derivative, the underlying assets can be stocks, bonds &amp; foreign exchanges etc.</td><td>In a commodity derivative, the underlying assets are commodities which make the agricultural commodities like cotton, wheat etc., metals like gold, silver etc., and energy resources like crude oil etc.</td></tr><tr><td>They are often cash settled</td><td>It may involve physical delivery.</td></tr><tr><td>Quality of the asset is not a major concern</td><td>Quality is a major concern.</td></tr><tr><td>No storage or transportation cost required here</td><td>Since commodities are perishable in nature, storage cost and transportation play a major role.</td></tr><tr><td>The primary users are investors, speculators &amp; financial institutions</td><td>The primary users are the producers, consumers, investors.</td></tr></tbody></table>\n<hr>\"\n<h2>Primary Market</h2>\n<h3>What is primary market?</h3>\n<ul><li>Segments of financial Market also known as new issue market.</li><li>Market place where companies, governments, or other institutions raise capital by issuing new Securities, such as shares for the first time.</li><li>The key characteristics of the primary market is that funds flow directly from the investors to the issuer.</li></ul>\n<h3>What is the role of primary market ?</h3>\n<ul><li>Serves the crucial role of capital formation.</li><li>Provides a platform for the issuers to raise the necessary funds for various purposes, such as:</li><li>starting new business</li><li>expanding and existing business</li><li>modernising a diversifying operations</li><li>For investors, it provides in opportunity to purchase security is direct from the issuers.</li></ul>\n<h3>Face value of share/debenture</h3>\n<ul><li>It is it&#039;s nominal value, as assigned by company at the time of issuance.</li><li>Original value printed on a physical share certificate or stated in the company&#039;s record.</li><li>Unlike market price, face value is a fixed amount that doesn&#039;t change with market fluctuations.</li><li>For a share, the face value is a foundational accounting figure.</li><li>For a debenture, the face value is the principle amount that the issuer promises to repay the debenture holder at the time of maturity.</li></ul>\n<h3>Premium and Discount</h3>\n<ul><li>When a security is sold above its face value --&gt; premium.</li><li>When a security is sold below its face value --&gt; discount.</li><li>Security guard generally issued in the denomination of 5 ,10, 100.</li></ul><br><hr><br>\n\n<h2>Different types of issues</h2>\n\n<ul><li><strong>Public issues:</strong> open to general public.</li></ul>\n<ol><li>Initial public offering: first time offer of the security by an unlisted company.</li><li>Further public offering: additional issue by an already listed company.</li></ol>\n<ul><li><strong>Right issue:</strong> securities offered to an existing shareholders in a specific ratio.</li><li><strong>Preferential issues: </strong>shares issued to a selected group not a public or right issue to quickly raise equity capital.</li></ul>\n\n<h3>Share price and market capitalisation</h3>\n<ul><li>Initial price at which a company&#039;s shares are offered in the primary market.</li><li>Calculated by multiplying the current share price by the number of shares in issue.</li></ul>\n\n<h3>Public issue Vs Private placement</h3>\n<ul><li><strong>Public issue:</strong> open to general public and involves allotment for 50 or more shares.</li><li><strong>Private placement:</strong> limited towards selected group, allotment made to less than 50 persons.</li></ul><br><hr><br>\n\n<h3>Book building process</h3>\n<ul><li>Mechanism for efficient price discovery during IPOs.</li><li>Investors bid at or above floor price during the open period.</li><li>The final issue price is determined after the bid closing date.</li><li>Allows daily demand tracking compared to single fixed demand of a normal price issue.</li></ul>\n<ol><li><strong>Cut off price :</strong> final issue price decided after considering all bids.</li><li><strong>Floor price: </strong>minimum price for the bid.</li><li><strong>Price Band: </strong>range within which the investors can build with the cap not exceeding 120% of the floor price.</li></ol>\n<h3>Other concepts</h3>\n<ul><li><strong>Lock in:</strong> restrictions on sale of shares for a specified period to ensure promoters retained a stake post issue.</li><li><strong>Listing of securities:</strong> admission of security for trading on a stock exchange.</li><li><strong>Delisting of securities: </strong>permanent removal of security is from the stock exchange.</li><li><strong>Listing agreement: </strong>at the time of listing securities of a company on a stock exchange, the company is required to enter into a listing agreement with the exchange . The agreement specifies the terms and conditions of listing and the disclosure on a continuous basis to the exchange .</li><li><strong>Prospectus:</strong> document containing detailed information about the company and the issue ; used to inform potential investors.</li></ul>\n\n<ul><li><strong>Regulators role:</strong></li>\n<ul><li>Finalizers the list of allottees.</li><li>Ensure credit to demat account.</li><li>Dispatches refund order and co-ordinate listing.</li></ul></ul>\n\n<ul><li><strong>SEBI&#039;s role in primary market</strong></li>\n<ul><li>Ensures adequate disclosure in the prospectus but does not recommend or guarantee issue.</li><li>Investors must make informed decisions based on the offer document content.</li></ul></ul>\n<ul><li><strong>American depository receipt</strong></li>\n<ul><li>Traded in US dollars.</li><li>Helps companies raise money from US investors.</li><li>It allows foreign investors to invest with Indian regulation.</li></ul></ul>\n<ul><li><strong>Global depository receipt</strong></li>\n<ul><li>Here shares of an Indian company is traded in market outside the US.</li><li>Ex: Reliance GDR in London stock exchange.</li></ul></ul>\n<ul><li><strong>Features of GDR</strong></li>\n<ul><li>Traded in forcing currencies like Euro/Pound.</li><li>Provides global recognition for Indian company.</li><li>Allows foreign investors to buy Indian shares easily.</li></ul></ul>\n\n<ul><li><strong>Indian depository receipt</strong></li>\n<ul><li>Shares of foreign companies traded in India.</li><li>Ex: Standard Charter Bank in India</li></ul></ul>\n<hr>\n\n<h2>Secondary market</h2>\n<strong>Meaning:</strong>\n<ul><li>Place where investors sell and buy existing securities.</li><li>Facilitates liquidity in securities.</li><li>Ex: National stock exchange, Bombay stock exchange</li></ul>\n<strong>Role of secondary market</strong>\n<ul><li>Provides liquidity to investors.</li><li>Determines market price of securities.</li><li>Helps in capital formation.</li><li>Facilitates easy entry and exit of security.</li></ul>\n<em>Difference between primary and secondary market</em>\n<table><thead><tr><th></th><th>primary market</th><th>secondary market</th></tr></thead><tbody><tr><td>Work</td><td>new issues of security</td><td>trading of existing shares</td></tr><tr><td>Participants</td><td>Issuers and investors</td><td>between investors</td></tr><tr><td>Price</td><td>issuer decides</td><td>decided by demand and supply</td></tr><tr><td>Sale</td><td>one time sales during issuing</td><td>continuous trading</td></tr></tbody></table>\n<h3>Stock exchange</h3>\n<ul><li>The stock exchange serves as market where financial institution like stock, Bond, commodities are traded.</li><li>Platform where buyers and sellers come together to trade financial tools during specific hours of a business deal.</li><li>Only those companies who are listed in a stock exchange are allowed to trade in it.</li><li>Stocks which are not listed on a reputed stock exchange and still be traded in an (over) (the) (counter) but still shares wouldn&#039;t be head high in stock market.</li><li>Provided regulated marketplace .</li><li>Ensures transparency and fair trading.</li><li>Protect investors interest.</li></ul>\n<strong>Major stock exchange in India</strong>\n<ul><li>Bombay Stock Exchange (BSE)</li><li>National Stock Exchange (NSE)</li></ul>\n<Br>\n<em>Bombay Stock Exchange (BSE)</em><p>This was established in 1875 in Bombay at Dalal Street. It is renowned as the oldest stock exchange in Asia and the 10th oldest in the world. It is world's sixth largest stock exchange by market capitalisation.</p>\n<Br>\n<em>National Stock Exchange (NSE)</em><p>\nInternational stock exchange was established in Mumbai in 1992 and is accredited as the pioneer among the demutualised Stock Exchange market in India. It is the world's 5th largest stock exchange by market capitalisation. This was established to eliminate the monopolistic impact of Bombay stock exchange in the Indian stock market.</p>\n<Strong>Stock Market Index</strong>\n\n<ul><li>Numerical representation of a group of stocks that is used to show their collective performance in the market.</li><li>Stock market index of BSE is SENSEX {sensitive index with biggest market cap}.</li><li>Stock market index of NSE is NIFTY {National Stock Exchange fifty}</li></ul>\n<strong>De-mutualisation Of Stock Exchange</strong>\n<ul><li>It refers to the legal structure of an exchange where by ownership, management and trading rights are separated.</li><li>Ownership is given to the investor</li><li>Management is the stock exchange</li><li>Trading is done by broker/trading member</li></ul>\n<em>Benefits of de-mutualisation</em>\n<ul><li>Reduce conflicts between investors and brokers .</li><li>Reduce chances of brokers using stock exchange for personal gains.</li></ul>\n<strong>Difference between mutual stock exchange and Demutualised Stock Exchange</strong>\n<table><thead><tr><th>Feature</th><th>mutual exchange</th><th>Demutualised exchange</th></tr></thead><tbody><tr><td>Ownership</td><td>managed and owned by broker who trade on it</td><td>owned by stock holder and not just broker</td></tr><tr><td>Management</td><td>broker act as owners, traders and managers</td><td>ownership, trading rights and management are separated</td></tr><tr><td>Profit objective</td><td>mainly serves the interest of broker members</td><td>aims to maximize value for the shareholder and maintain fair feeding</td></tr><tr><td>transparency</td><td>less transparent due to conflict of interest</td><td>more transparent as management is independent of traders</td></tr><tr><td>example</td><td>traditional stock exchange is before reforms</td><td>modern stock exchanges like NSE and BSE for  demutualisation</td></tr></tbody></table>\n<strong>Stock trading</strong><p>Stock trading is the buying and selling of shares of companies through a stock exchange to make a profit.</p>\n\n<strong>Screen based trading</strong><p>method where buying and selling of shares is done through a computerised system instead of face to face on the trading floor.</p>\n<ul><li>All orders are entered on a screen {computer terminal}.</li><li>All system matches buy and sell orders automatically.</li><li>This electronic system is replacing the open out cry { traditional method of trading in stock exchange where traders shout bid and offers on a trading floor to buy or sell shares }.</li></ul>\n<strong>NEAT</strong>\n<ul><li>National exchange for automated trading is an electronic trading system used by National Stock Exchange of India.</li><li>It enables screen based, automated and order driven trading of shares and other securities.</li></ul>\n<em>Key features:</em>\n<ul><li>Fully computerised : matches  buy or sell orders automatically.</li><li>Order driven system: orders are matched based on price timing priority.</li><li>Transparency : all investors can see prices and trades in real time.</li><li>Speed and accuracy : eliminates human errors found in the open out cry system</li></ul>\n<strong>How to place an order</strong>\n<ol><li>Contact registered broker /sub broker.</li><li>Specify buy/sell and quantity price.</li><li>Broker places order on stock exchange platform.</li></ol>\n<strong>Internet Based Trading</strong>\n<ul><li>Open a Demat Account (to) ( hold) (shares) ( electronically)</li><li>Open a Trading Account (through) ( a ) (registered ) (broker)</li><li>Link Bank Account (for fund ) (transfer)</li><li>Obtain Login Credentials from Broker (username) ( and) ( password)</li><li>Access Broker&#039;s Online Platform (website ) (or) ( app)</li><li>Starting Trading (buy/sell ) (shares) ( in ) (real ) (time)</li></ul>\n<h1>Contract Note</h1>\n<P>\nA Contract Note is a legal document given by a stockbroker to an investor after a trade is completed. It serves as proof that the transaction took place.</p>\n\n<strong>Importance of a Contract Note</strong>\n<ul><li>Legal Proof of Transaction: Acts as evidence that a trade has been carried out through a registered broker.</li><li>Prevents Disputes: Helps resolve any disagreements between the investor and broker about trade details.</li><li>Transparency: Provide clear details of price, quantity &amp; brokerage charges.</li><li>Tax Reporting: required for calculating capital gains &amp; filing income tax returns.</li><li>For Regulatory Compliance: Mandated by SEBI to protect investors.</li><li>Audit &amp; Record Keeping: Useful for maintaining proper records of all trading activities.</li></ul>\n<strong>Key Details in a Contract Note</strong>\n<ul><li>Trade Details: Name of security, quantity, price, and date of trade.</li><li>Broker&#039;s Information: Name, registration number &amp; signature.</li><li>Investor&#039;s Information: Client code or account details.</li><li>Unique Identification Number (UIN): To track the trade.</li><li>Charges: Brokerage, service tax, stamp duty, etc.</li></ul>\n<div class=\"qa-block\" data-qa-type=\"qa\" data-question=\"Maximum Brokerage that Broker can charge?\" data-answer=\"Cannot be more than 2.5% of the value mentioned in the respective purchase or sale note.\"><p><strong>Q:</strong> Maximum Brokerage that Broker can charge?</p><p><strong>A:</strong> Cannot be more than 2.5% of the value mentioned in the respective purchase or sale note.</p></div>\n<strong>Why should one trade on a recognized Stock Exchange only for buying/selling shares</strong>\n<ul><li>Regulated by SEBI</li><li>Ensures investor protection</li><li>Transparent pricing</li><li>Settlement guarantee</li></ul>\n<strong>Precautions before Investing</strong>\n<ul><li>Verify broker registration</li><li>Understand the product</li><li>Check company fundamentals</li><li>Avoid rumors &amp; tips</li></ul>\n<h3>Do&#039;s &amp; Don&#039;ts</h3>\n<strong>Do&#039;s</strong>\n<ul><li>Deal only with registered brokers</li><li>Maintain documentation</li><li>Diversify investments</li></ul>\n<strong>Don&#039;ts</strong>\n<ul><li>Don&#039;t invest without research</li><li>Don&#039;t trade on rumors</li><li>Don&#039;t share passwords</li></ul>\n<h3>Products in Secondary Market</h3>\n<em>Shares: equity ownership</em>\n<ul><li>Equity Shares: An equity share, commonly referred to as ordinary share, represents the fractional (multiple) ownership in a company.</li><li>Right Issue / Share: The issue of new security to the existing shareholders at the ratio to those already had.</li><li>Bonus Share: Shares issued by the companies to their shareholders free of cost based on the number of shares they already had.</li><li>Preference Share: Also known as preferred stock, are a type of equity security that gives shareholders a higher claim on a company&#039;s assets and earnings than common stockholders. They are called &#039;preference&#039; shares because they receive priority in dividend payments and in distribution of company&#039;s assets if liquidated.</li>\n<li>Cumulative Convertible Share: These shares give the holder the right to receive any unpaid dividends from previous years. The company must pay all accumulated dividend arrears before paying out any dividends to common shareholders.</li>\n<li>Cumulative Convertible Preference Share :This type of share combines the features of cumulative shares with the option to convert them into a set number of common shares. This allows investors to receive fixed dividends and potentially benefit from future capital appreciation.</li></ul>\n<h2>Bonds: Fixed Return Debt Instruments</h2>\n<P>\nA bond is a debt security where an investor lends money to a borrower (like a company or government) in exchange for regular interest payments and the return of the principal at maturity.</p>\n\n<strong>Zero-Coupon Bond</strong><p>\nThis is a bond that does not pay periodic interest. Instead, it is issued at a deep discount to its face value. The investor's return is the difference between the purchase price and the full value received at maturity. </p>\n\n<strong>Convertible Bond</strong><p>A type of bond that the holder can choose to convert into a predetermined number of the issuing company's common shares. It offers the stability of a bond with the potential for equity-like returns.\n</p>\n<strong>Treasury Bills (T-Bill)</strong>\n<ul><li>A short-term, zero-coupon debt security issued by a government. It is considered one of the safest investments due to being backed by the full faith and credit of the government.</li></ul>\n<strong>Why Invest in Equities in Particular?</strong>\n<ul><li>Potential for High Returns</li><li>Inflation Hedge</li><li>High Liquidity</li><li>Ownership &amp; Voting Rights</li><li>Easy Diversification</li></ul>\n<strong>Factors that Influence the Price of Stocks</strong>\n<ul><li>STOCK SPECIFIC FACTOR: These are unique factors to the company. They include the financial performance (profit, revenue), management decisions (strategy, dividend), specific news, or events (product launches), etc.</li><li>MARKET SPECIFIC FACTOR: These affect the entire market. They include broader economic conditions (GDP, interest rate), government policy (new laws, regulation), and overall investor sentiments driven by global events.</li></ul>\n<h3>Types of Equity Investments</h3>\n<strong>Growth Stock</strong>\n<ul><li>These are high-appreciation stocks.</li><li>They represent shares in a company expected to grow at an above-average rate.</li><li>Investors buy them for capital appreciation (stock price growth) and are willing to pay a high price for them based on future potential.</li><li>They typically don&#039;t pay dividends, as they re-invest profits back into the business to fuel their expansion.</li><li>These are generally considered risky.</li></ul>\n<strong>Value Stock (Undervalued) (but) ( Strong)</strong>\n<ul><li>These are shares in a well-established company that the market appears to have undervalued.</li><li>They often have stable business models and pay a regular dividend.</li><li>They trade at a lower price relative to their earnings.</li><li>Investors buy them believing the market will eventually correct the price, allowing them to profit from both the price increase and the regular dividend.</li></ul>\n\n\n<h3>Key Trading Terms</h3>\n<strong>Bid Price &amp; Ask Price</strong>\n<ul><li>Bid price is the buyer&#039;s price. You need to know the bid price when you sell a stock.</li><li>Ask price is the seller&#039;s price. You need to know the ask price when you buy a stock. The seller will sell their stock if they get the &#039;ask price&#039;.</li></ul>\n<strong>Portfolio</strong>\n<ul><li>A portfolio is a combination of different investment assets matched to achieve an investor&#039;s goals. Items considered part of a portfolio can include any assets you own, from shares, debentures, bonds, and mutual fund units to items like gold, art, and even real estate.</li></ul>\n\n<strong>Diversification</strong>\n<ul><li>Diversification is a risk management technique that mixes a wide variety of investments within a portfolio. It&#039;s designed to minimize the impact of any single security on your overall portfolio performance.</li><li>The main advantage is that if you spread your investment across various types of assets and markets, you&#039;ll reduce the risk of your entire portfolio being affected by the poor performance of any single asset.</li></ul>\n<h3>Debt Instruments</h3>\n<P>\nA debt instrument is a contract where one party lends money to another on pre-determined terms regarding the interest rate, frequency of interest payments, and the repayment of the principal amount by the borrower.</p>\n<ul><li>A &#039;Bond&#039; is a debt instrument issued by the government.</li><li>A &#039;Debenture&#039; is a debt instrument issued by public sector organizations.</li></ul>\n<strong>Features of Debt Instruments</strong>\n<ul><li>MATURITY: This is the date on which the bond matures, which is when the borrower has agreed to repay the principal amount.</li><li>TERM-TO-MATURITY: This refers to the number of years remaining until the bond matures. It changes every day from the date the bond is issued until it reaches maturity.</li><li>COUPON: This is the periodic interest payment made by the borrower to the lender. The coupon rate is the rate at which interest is paid, usually represented as a percentage of the bond&#039;s face value.</li><li>PRINCIPAL: This is the amount that has been borrowed. It&#039;s also called the face value or par value of the bond.</li></ul>\n\n\n<h3>The Debt Market</h3>\n<strong>Interest Payable by a Debenture/Bond</strong>\n<ul><li>Interest is the amount paid by the borrower (the company) to the lender (the debenture holder) for borrowing the money. Interest may be paid annually, semi-annually, quarterly, or monthly and is usually calculated on the face value of the bond.</li></ul>\n<strong>Segments in the Debt Market</strong>\n<ul><li>Government Securities (GS)</li><li>Public Sector Units (PSU)</li><li>Corporate Securities (CS)</li></ul>\n<strong>Participants in the Debt Market</strong>\n<ul><li>The debt market is predominantly a wholesale market with dominant institutional investor participation. The main investors are banks, financial institutions, mutual funds, provident funds, insurance companies, and corporates.</li></ul>\n<strong>Bond related for there Credit quality</strong>\n<ul><li>The main credit rating agencies in India are CRISIL, CARE, ICRA, and Fitch. The yield (return) on a bond varies inversely with its credit (safety) rating. The safer the instrument, the lower the rate of interest.</li></ul>\n<div class=\"qa-block\" data-qa-type=\"qa\" data-question=\"How to Acquire Debt Securities?\" data-answer=\"You can subscribe to issues by the government or corporations in the primary market. Alternatively, you can purchase them from the secondary market through stock exchanges.\"><p><strong>Q:</strong> How to Acquire Debt Securities?</p><p><strong>A:</strong> You can subscribe to issues by the government or corporations in the primary market. Alternatively, you can purchase them from the secondary market through stock exchanges.</p></div\n<hr>\n<hr>\n<h2>Depository</h2>\n<ul><li>Like banks for Securities.</li><li>Holds securities in electronic form.</li><li>It helps in trading, holding and transferring securities safely.</li></ul>\n<h3>Need for depository</h3>\n<ul><li>To avoid problems of physical state certificate.</li><li>Ensures faster and safer transfer of securities.</li><li>Reduces paper work and fraud.</li></ul>\n<h3>Functions of depository</h3>\n<ul><li>It allows security is in electronic form.</li><li>Facilitates transfer of ownership.</li><li>Act as a link between investors and companies.</li><li>Provides dematerialisation.</li></ul>\n<h3>Participants in depository</h3>\n<ul><li>Depository (eg., NSDL , CDSL )</li><li>Depository participants</li><li>Investors</li><li>Issuers</li></ul>\n<h3>Depositories in India</h3>\n<ol><li>Central depository service limited (CDSL).</li><li>National Securities Depository Limited (NSDL).</li></ol>\n<ul><li>Both are controlled by SEBI.</li></ul>\n<h3>Benefits of depository</h3>\n<ul><li>Immediate transfer of securities.</li><li>Reduction in paper work, involved in transfer of securities.</li><li>Eliminates risk of physical certificate.</li><li>Quick settlement of trades.</li><li>Easy transfer of shares.</li><li>Save time and cost.</li><li>No stamp duties on transfer of security.</li><li>Convenient method of consolidation of folios, accounts.</li><li>Ease of nomination.</li></ul>\n<h3>Depository participants</h3>\n<ul><li>Link between the invester and the depository.</li><li>Like a bank branch but instead of holding money, it helps in holding and managing your securities.</li><li>To open a demat account, and investor must go to a depository participant.</li></ul>\n<h3>Rolls of Depository participant</h3>\n<ul><li>Account opening: helps investors open demat account to hold security is electronically.</li><li>Dematerialisation: convert physical shares into electronic form  .</li><li>Rematerialization : convert electronic shares into physical form .</li><li>Settlement of trades: ensures smooth transfer when you buy or sell.</li><li>Account maintenance: keep records of securities and send periodic statements to investors.</li></ul>\n<h3>Examples of depository participant</h3>\n<ul><li>Banks (eg., HDFC)</li><li>Stock brokers(eg., Angel one)</li><li>Financial institutions(eg., Kotak securities)</li></ul>\n<h3>International security identification number (ISIN)</h3>\n<ul><li>Unique 12 digit code that identifies a specific security worldwide.</li></ul>\n<strong>Structure of ISIN</strong>\n<ul><li>two-letter country code, a nine-character alphanumeric national securities identifier, and a single check digit.</li></ul>\n<strong>Importance of ISIN</strong>\n<ul><li>Avoids confusion between securities with similar names.</li><li>Used globally.</li></ul>\n<h3>Custodian</h3>\n<ul><li>Institution are individual responsible for holding and safeguard of securities on behalf of client.</li></ul>\n<strong>Role of custodian</strong>\n<ul><li>Maintains and protects clients&#039; securities.</li><li>Handles settlement of trade.</li><li>Collects income such as dividend or interest.</li><li>Provides corporate action services and ensure accurate record keeping</li><li>eg., stock holding corporation of India Limited (SHCIL)</li></ul>\n\n<h3>Dematerialization and rematerialization</h3>\n<ul><li>Dematerialisation: converting physical shares into electronic shares.</li><li>Re materialisation: converting electronics shares into physical certificate .</li><li>Service provided by depository.</li></ul>\n<hr>\n                    \n<h2>Mutual Funds</h2>\n\n<ul><li>Mutual fund is a special kind of investment through which you can invest in different types of securities together.</li><li>It is a collective investment scheme pooling money from many investors.</li><li>It is managed by AMC who appoints expert fund managers.</li><li>Investors can invest in stocks, bonds and other assets.</li><li>It helps you in diversified investment and reduce individual risk.</li></ul>\n<h3>Asset management company (AMC)</h3>\n<ul><li>Opens mutual fund.</li><li>Appoints expert and through their advice, they invest money at different places.</li><li>This AMCs keep 1 to 2% profit and returns, rest to its investors.</li><li>If AMC invest in your money in\n<ol><li>Stocks - high risk - high return</li><li>Government bonds - low risk - low returns</li></ol></li><li>HDFC,HSBC,ICICI , Aditya Birla, Tata, etc., are the companies/banks who open mutual fund.</li></ul>\n<h3>Benefits of mutual funds</h3>\n<ul><li>Small investment</li><li>Professional fund management</li><li>Spreading risk</li><li>Transparency</li><li>Choice</li></ul>\n<h3>Net asset value (NAV)</h3>\n<ul><li>Net asset value is the price at which you buy or sell mutual funds unit and it changes everyday.</li></ul>\n<div class=\"formula-block-iframe\">\n$$\n\\text{NAV} = \\frac{\\text{Total Assets} - \\big(\\text{Total Liabilities} + \\text{Expenses}\\big)}{\\text{Total Outstanding Units}}\n$$\n</div>\n<div class=\"qa-block\" data-qa-type=\"qa\" data-question=\"Find NAV, if assets is equal to 10 lakh, liabilities = 1 lakh, expenses of 2% of assets per annum and total number of units are 90000.\" data-answer=\"<div class='formula-block-iframe'>$$ \\text{NAV} = \\frac{10,00,000 - (1,00,000 + 20,000)}{90,000} = \\frac{8,80,000}{90,000} \\approx 9.78 $$</div>\">\n  <p><strong>Q:</strong> Find NAV, if assets is equal to 10 lakh, liabilities = 1 lakh, expenses of 2% of assets per annum and total number of units are 90000.</p>\n  <p><strong>A:</strong> \n  </p>\n\n<div class='formula-block-iframe'>$$ \\text{NAV} = \\frac{10,00,000 - (1,00,000 + 20,000)}{90,000} = \\frac{8,80,000}{90,000} \\approx 9.78 $$</div>\n</Div>\n<h3>Risk involved in mutual funds</h3>\n<ul><li><strong>Market risk :</strong> factors such as economic condition, government policies, interest rate and investor sentiments can influence the fund. Overall performance of the market can influence the mutual funds also.</li><li><strong>Non market risk:</strong> the potential gain and risk in a portfolio which is non related by the movement of the market in general. Bad news of an individual company can bring down it&#039;s stock prices which can negatively affect the fund holding.</li><li><strong>Interest rate risk :</strong>\n<ol><li>Bond price and interest rate moves in opposite direction.</li><li>When interest rate increases Bond prices fall.</li><li>The decline in underline asset affect the one negatively</li></ol></li><li><strong>Credit risk :</strong> chances that the borrower doesn&#039;t repay the loan or fulfill loan obligation. It leads to the fall in the value of the bond causing net asset value of the fund to take a beating.</li></ul>\n<h3>Types of mutual funds</h3>\n<strong>Equity funds/ Growth funds</strong>\n<ul><li>Funds that invest in equity are called equity funds .</li><li>High risk brings you high returns.</li><li>Best suited for investors seeking capital appreciation.</li><li>Further divided into diversified funds, sector specific funds and index based funds</li></ul>\n<ol><li>Diversified funds\n<ul><li>These funds invest in companies spread across sectors.</li><li>Investment is done in large cap, small cap and mid cap.</li><li>Also called &#039;Equity linked saving scheme( ElSS)&#039;.</li><li>These funds save tax on profit.</li></ul></li><li>Sector specific funds\n<ul><li>These funds invest in particular business sector or industries.</li><li>Ex: agriculture sector, logistics, etc.</li><li>This is high risky fund.</li><li>These funds are targeted at investors who are attracted at the prospectus of a particular sector.</li></ul></li><li>Index based funds\n<ul><li>The money collected from the investors is invested only in the stocks when represent the index.</li><li>Ex: Nifty index fund will only invest in nifty fifty stocks.</li><li>The objective of such fund is not to beat the market but to give a return equivalent to the market returns</li></ul></li></ol>\n<strong>Tax saving funds</strong>\n<ul><li>These funds offer the benefit to invest under the income tax act.</li><li>Opportunities provided under the scheme are in the form of tax rebate under the income tax act.</li></ul>\n<strong>Debt mutual funds</strong>\n<ul><li>These funds invest periodically in high rated income bearing instruments like bonds, debenture, government securities, commercial market and others.</li><li>They are best suited for the medium to long investors who are adverse to risk and see capital preservation.</li><li>Provide regular income to the investors.</li></ul>\n<strong>Liquid funds/Money market fund</strong>\n<ul><li>Invest in high liquid money market fund.</li><li>Period of investment can be as short as a day.</li><li>Emerged as an alternative for savings and short term deposit account with comparatively high returns.</li><li>These funds are ideal for corporate, institutional investors and business houses that invest their funds for a very short period of time.</li></ul>\n<strong>Gilt funds</strong>\n<ul><li>These funds invest in Central and state Securities. Since they are government securities they give us secure returns and also ensures safety to principal amount.</li><li>Best suited for medium to long term investors who are averse to risk.</li></ul>\n<strong>Balanced fund/Hybrid funds</strong>\n<ul><li>These funds invest both in equity shares and fixed income bearings instrument in some proportion.</li><li>They provide steady returns and reduce the volatility of the find while providing upside for capital appreciation.</li><li>They are ideal for medium to long term investors who are willing to take moderate risk.</li></ul>\n<strong>Types of hybrid funds</strong>\n<ul><li>Balanced saving fund\n<ul><li>If more money is invested in debt instrument. The ratio of 70% in bonds and 30% in equity. This type of investment is less risky.</li></ul></li><li>Balanced advantage fund</li>\n<ul><li>If more money is invested in equity that is 70% in equity and 30% in bonds. These types of investment is more risky.</li></ul></ul>\n\n<h3>Growth plan</h3>\n<ul><li>A plan under a scheme where in the return from an investment are re invested and few income distribution is made.</li><li>The investors only realises capital appreciation on the investment.</li></ul>\n<h3>Dividend plan</h3>\n<ul><li>Also known as income distribution cum withdrawal (IDCW).</li><li>Under the IDCW income is distributed from time to time.</li><li>This plan is ideal to those investors requiring regular income.</li></ul>\n<h3>Dividend re investment plan (DRP)</h3>\n<ul><li>Dividend plan of scheme carry an additional option of income distribution. This is referred to as DRP.</li><li>Under this plan dividend declared by a fund are re invested in the scheme on behalf of the investor, thus increasing the number of units held by the investors.</li></ul>\n<h3>Difference between active and passive fund managers</h3><table><thead><tr><th>Criteria</th><th>Active Fund Management</th><th>Passive Fund Management</th></tr></thead><tbody><tr><td>Description</td><td>Created around a specific theme or strategy by experts</td><td>Designed to replicate the performance of index like NIFTY, SENSEX</td></tr><tr><td>Goal</td><td>Aims to surpass the performance of the broad market index</td><td>Seeks to replicate or match the performance of the market index</td></tr><tr><td>Management</td><td>Fund management selects the underlying securities based on market conditions and fund theme objective</td><td>Simply tracks market indices, no regular fund management required</td></tr><tr><td>Tax Efficiency</td><td>Higher turnover leads to capital gains distribution in comparison</td><td>Capital gains distribution tend to be lower compared to actively managed funds</td></tr><tr><td>Risk</td><td>Active funds could be riskier when compared to passive funds as returns are dependent on the fund manager's judgement skills</td><td>Passive investment removes the human bias by following the rule-based approach, ensuring diversification, reducing emotional decisions and lowering risk</td></tr></tbody></table>\n<h3>Growth investing vs. value investing</h3>\n<table><thead><tr><th>Category</th><th>growth investing</th><th>value investing</th></tr></thead><tbody><tr><td>Focus</td><td>earning offer</td><td>current under valuation</td></tr><tr><td>Company type</td><td>high growth/scalable</td><td>established, stable</td></tr><tr><td>Risk level</td><td>high risk and vitality</td><td>low risk and stability</td></tr><tr><td>Dividend</td><td>usually no or low</td><td>often</td></tr><tr><td>P/E ratio</td><td>typically high</td><td>typically low</td></tr><tr><td>Investors profile</td><td>aggressive and long term</td><td>conservative and value focused</td></tr></tbody></table>\n<h3>Exchange traded funds (ETF)</h3>\n<ul><li>Credit like stocks but follow an index or asset.</li><li>Offer liquidity and flexibility.</li><li>Low management cost.</li><li>Can we bought and sold anytime during the market hours.</li></ul>\n<hr>\n<h2>Miscellaneous</h2>\n<p>Q1.What are Corporate Actions ?</p>\n<p>Corporate actions are events initiated by a company that bring changes to its securities, impacting shareholders or bondholders. These actions can include a range of financial maneuvers or operational changes. Some common types of corporate actions include:</p>\n<p>1. Dividends: Payments made to shareholders, often as a distribution of profits.</p>\n<p>2. Stock Splits: The company divides its existing shares into multiple new shares to increase liquidity.</p>\n<p>3. Mergers and Acquisitions (M&amp;A): The company merges with or acquires another business, affecting ownership and stock value.</p>\n<p>4. Rights Issue: Existing shareholders are offered the opportunity to buy additional shares at a discount.</p>\n<p>5. Buybacks: The company repurchases its own shares, often to boost share value.</p>\n<p>6. Spin-offs: The company creates a new independent company by distributing shares of the new entity to existing shareholders.</p>\n<p>These actions can affect the stock price, market perception, and the ownership structure of the company.</p>\n<p>Q2. What is meant by Dividend yield ?</p>\n<p>Ans. Dividend yield is a financial ratio that indicates how much a company pays out in dividends each year relative to its stock price. It is expressed as a percentage and helps investors evaluate the return they can expect from dividends in relation to the price they paid for the stock.</p>\n<p>The formula for dividend yield is:</p>\n<p>Dividend Yield : Annual Dividend per share / Price per share x100</p>\n<p>Q3. What is meant by dividend declared by companies ?</p>\n<p>When a company declares a dividend, it announces its intention to distribute a portion of its profits to shareholders. This declaration is typically made after the company’s board of directors decides the amount and the date when the dividend will be paid.</p>\n<p>Dividends are usually paid in cash, but they can also be distributed in the form of additional shares (stock dividends).</p>\n<p>Q4. What is stock split</p>\n<p>A stock split is a corporate action in which a company increases the number of its outstanding shares by issuing more shares to existing shareholders. However, the overall market value of the company remains the same because the price of each share is adjusted proportionally.</p>\n<p>Companies usually perform stock splits to make their shares more affordable for investors, improve liquidity, and attract a broader base of shareholders.</p>\n<p>Types of Stock Splits:</p>\n<p>1. Forward Stock Split</p>\n<p>2. Reverse Stock Split</p>\n<p>Stock splits don&#39;t change the overall value of a shareholder&#39;s investment, but they can influence market perception and trading activity.</p>\n<p>Q5. Why do companies announce stock split?</p>\n<p>Ans. Companies announce stock splits for several strategic reasons, primarily aimed at making their stock more attractive and accessible to investors. The main reasons of stock split are:</p>\n<p>1. To Increase Liquidity</p>\n<p>2. Improve Affordability</p>\n<p>3. Psychological Impact</p>\n<p>4. Sign of Confidence</p>\n<p>5. Align with Market Peers.</p>\n<p>6. Attract Retail Investors</p>\n<p>Ultimately, stock splits are a way for companies to enhance marketability without affecting the underlying value of the business.</p>\n<p>Q6. What is buyback of shares ?</p>\n<p>Ans. A buyback of shares (also known as a share repurchase) occurs when a company buys back its own shares from the open market or directly from shareholders. This reduces the number of outstanding shares in the market.</p>\n<p>Q7. What is the Nifty index ?</p>\n<p>Ans. The Nifty Index, also known as the Nifty 50, is a stock market index in India that represents the performance of 50 of the largest and most liquid companies listed on the National Stock Exchange (NSE). It is a benchmark index widely used to gauge the overall health of the Indian equity market. The Nifty 50 is one of the key indicators of the Indian stock market&#39;s performance and provides insights into the economic conditions of the country.</p>\n<p>Q8. What is a clearing corporation ?</p>\n<p>Ans. A clearing corporation is an entity that facilitates the smooth settlement of trades and ensures that transactions between buyers and sellers in financial markets are completed properly. It acts as a middleman between the two parties involved in the transaction, guaranteeing the execution of trades, even if one party defaults. Clearing corporations are crucial in ensuring the stability, transparency, and efficiency of financial markets.</p>\n<p>Q9. What is Rolling settlement ?</p>\n<p>Ans. Rolling settlement is a process in financial markets where trades are settled on a continuous, day-to-day basis, rather than on a specific set date for all trades. Under this system, transactions are settled a fixed number of days after the trade date, typically on a T+X basis, where T stands for the trade date and X represents the number of business days after the trade date when settlement takes place.</p>\n<p>Q10. What is Pay- in and Pay-out ?</p>\n<p>Ans. Pay-in and Pay-out are terms used in the context of the settlement process in financial markets, particularly in stock exchanges, to describe the transfer of funds and securities between parties involved in a trade.</p>\n<p>Pay-in:</p>\n<p>Definition: Pay-in refers to the process where brokers transfer the funds (for buyers) and securities (for sellers) to the clearing corporation on the settlement day.</p>\n<p>Pay-out:</p>\n<p>Definition: Pay-out refers to the process where the clearing corporation transfers the securities to the buyer and the funds to the seller after the pay-in process is complete.</p>\n<p>Q11. What is an Auction?</p>\n<p>An auction is a public sale in which goods or property are sold to the highest bidder. It is a competitive process where potential buyers place bids on items, and the item is sold to the individual who offers the highest price. Auctions can be used for a wide range of items, including real estate, artwork, antiques, vehicles, and financial instruments.</p>\n<p>Q12. What is a Book clouser/Record date?</p>\n<p>Ans. The book closure date (or record date) is an important date in the context of corporate actions, particularly regarding dividends, stock splits, and rights issues.</p>\n<p>Book Closure Date : The book closure date is a period during which a company temporarily closes its share register for the purpose of determining which shareholders are eligible to receive dividends, participate in rights issues, or be entitled to any other corporate actions.</p>\n<p>Record Date : The record date is the specific date set by the company to determine which shareholders are eligible to receive dividends, participate in a rights issue, or benefit from any other corporate actions.</p>\n<p>Q13. What is a No -delivery period?</p>\n<p>Ans. A no-delivery period is a specific timeframe during which the trading of a security occurs without the actual transfer of ownership or delivery of the underlying asset. This period is often associated with corporate actions, such as dividends, rights issues, or stock splits, and it typically precedes the record date or book closure date.</p>\n<p>Q14. What is Ex dividend date?</p>\n<p>Ans. This is the date on which a stock starts trading without the value of the next dividend payment. If an investor buys shares on or after this date, they will not receive the upcoming dividend. Instead, the dividend will be paid only to those who purchased the shares before the ex-dividend date.</p>\n<p>Q15. What is Arbitration?</p>\n<p>Ans. Arbitration is a form of alternative dispute resolution (ADR) where disputes between parties are settled by one or more arbitrators, rather than through litigation in court. This process is often used in commercial disputes, including those related to contracts, investments, and financial transactions.</p>\n<p>Q16. What is an Investor Protection Fund?</p>\n<p>An Investor Protection Fund (IPF) is a safety net designed to protect the interests of investors by providing compensation in the event of financial losses due to certain circumstances, such as the failure of a financial institution, fraudulent activities, or defaults.</p>\n<p>Investor Protection Funds play a crucial role in enhancing the safety and stability of financial markets by providing compensation to investors for losses incurred under specific conditions. They help build trust among investors, encouraging participation in the markets and contributing to overall market development. However, it’s important for investors to understand the terms, limits, and eligibility criteria associated with these funds.</p>\n<hr>\n<h2><strong>CONCEPTS &amp; MODES OF ANALYSIS</strong></h2>\n<h2><strong>Simple Interest</strong></h2>\n<h3>Definition</h3>\n<ul>\n<li>Interest paid <strong>only on the principal amount</strong> borrowed </li>\n<li><strong>No interest</strong> is paid on the interest accrued during the loan term</li>\n</ul>\n<h3>Components</h3>\n<p>Three components required to calculate simple interest: </p>\n<ul>\n<li><strong>Principal (P)</strong></li>\n<li><strong>Interest Rate (r)</strong> - per year</li>\n<li><strong>Time (t)</strong> - in years or fraction of a year</li>\n</ul>\n<h3>Formula</h3>\n<div class=\"formula-block-iframe\">$ I = P \\times r \\times t $</div> \n\n<p>Where:</p>\n<ul>\n<li>$ I $ = Interest</li>\n<li>$ P $ = Principal</li>\n<li>$ r $ = Interest rate (per year)</li>\n<li>$ t $ = Time (in years or fraction of a year)</li>\n</ul>\n<h3>Examples</h3>\n<h4>Example 1: 8 Months Loan</h4>\n<ul>\n<li><strong>Principal:</strong> Rs. 10,000 </li>\n<li><strong>Rate:</strong> 10% per annum (0.10)</li>\n<li><strong>Time:</strong> 8/12 year</li>\n<li><strong>Interest:</strong> $ I = 10,000 \\times 0.10 \\times \\frac{8}{12} = \\text{Rs. } 667 $</li>\n</ul>\n<h4>Example 2: 15 Months Loan</h4>\n<ul>\n<li><strong>Principal:</strong> Rs. 10,000 </li>\n<li><strong>Rate:</strong> 10% per annum (0.10)</li>\n<li><strong>Time:</strong> 15/12 year</li>\n<li><strong>Interest:</strong> $ I = 10,000 \\times 0.10 \\times \\frac{15}{12} = \\text{Rs. } 1,250 $</li>\n</ul>\n<hr>\n<h2><strong>Compound Interest</strong></h2>\n<h3>Definition</h3>\n<ul>\n<li>Interest calculated on <strong>interest</strong> </li>\n<li>Interest accrued on principal is <strong>added back</strong> to the principal sum </li>\n<li>The whole amount is treated as <strong>new principal</strong> for the next period calculation</li>\n</ul>\n<h3>Important Note</h3>\n<p><strong>Unless simple interest is stated, always assume interest is compounded</strong> </p>\n<h3>Conversion Period</h3>\n<ul>\n<li>Refers to <strong>how often the interest is calculated</strong> over the term of loan/investment </li>\n<li>Must be determined for each year or fraction of a year </li>\n<li><strong>Semiannual compounding:</strong> 2 conversion periods per year </li>\n<li><strong>Quarterly compounding:</strong> 4 conversion periods per year</li>\n</ul>\n<h3>Formula</h3>\n<div class=\"formula-block-iframe\">$ C = P(1 + i)^n $</div> \n\n<p>Where:</p>\n<ul>\n<li>$ C $ = Amount</li>\n<li>$ P $ = Principal</li>\n<li>$ i $ = Interest rate per conversion period</li>\n<li>$ n $ = Total number of conversion periods</li>\n</ul>\n<h3>Example: Quarterly Compounding</h3>\n<p><strong>Given:</strong> </p>\n<ul>\n<li>Principal: Rs. 10,000</li>\n<li>Interest rate: 7.5% per annum</li>\n<li>Time: 5 years</li>\n<li>Compounding: Quarterly</li>\n</ul>\n<p><strong>Calculation:</strong></p>\n<ul>\n<li>$ i = \\frac{0.075}{4} = 0.01875 $</li>\n<li>$ n = 4 \\times 5 = 20 $ conversion periods</li>\n<li>$ C = 10,000(1 + 0.01875)^{20} = 10,000 \\times 1.449948 = \\text{Rs. } 14,499.48 $</li>\n<li><strong>Interest earned:</strong> Rs. 4,499.48</li>\n</ul>\n<h3>Comparison: Simple vs Compound Interest</h3>\n<p><strong>Same investment at 7.5% for 5 years:</strong> </p>\n<table>\n<thead>\n<tr>\n<th>Method</th>\n<th>Formula</th>\n<th>Amount</th>\n<th>Interest Earned</th>\n</tr>\n</thead>\n<tbody><tr>\n<td><strong>Simple Interest</strong></td>\n<td>$ S = P(1 + rt) $</td>\n<td>Rs. 13,750</td>\n<td>Rs. 3,750</td>\n</tr>\n<tr>\n<td><strong>Compound Interest</strong></td>\n<td>$ C = P(1 + i)^n $</td>\n<td>Rs. 14,499.48</td>\n<td>Rs. 4,499.48</td>\n</tr>\n<tr>\n<td><strong>Difference</strong></td>\n<td>-</td>\n<td>-</td>\n<td><strong>Rs. 749.48 (20% more)</strong></td>\n</tr>\n</tbody></table>\n<hr>\n<h2><strong>Power of Compounding</strong></h2>\n<h3>Definition</h3>\n<ul>\n<li><strong>Re-investment of income</strong> at the same rate of return </li>\n<li>Constantly grows the principal amount year after year </li>\n<li>Higher the rate of return, more income gets added back to principal</li>\n</ul>\n<h3>Impact of Compounding on Rs. 10,000</h3>\n<table>\n<thead>\n<tr>\n<th><strong>Year</strong></th>\n<th><strong>5%</strong></th>\n<th><strong>10%</strong></th>\n<th><strong>15%</strong></th>\n<th><strong>20%</strong></th>\n</tr>\n</thead>\n<tbody><tr>\n<td>1</td>\n<td>Rs. 10,500</td>\n<td>Rs. 11,000</td>\n<td>Rs. 11,500</td>\n<td>Rs. 12,000</td>\n</tr>\n<tr>\n<td>5</td>\n<td>Rs. 12,800</td>\n<td>Rs. 16,100</td>\n<td>Rs. 20,100</td>\n<td>Rs. 24,900</td>\n</tr>\n<tr>\n<td>10</td>\n<td>Rs. 16,300</td>\n<td>Rs. 25,900</td>\n<td>Rs. 40,500</td>\n<td>Rs. 61,900</td>\n</tr>\n<tr>\n<td>15</td>\n<td>Rs. 20,800</td>\n<td>Rs. 41,800</td>\n<td>Rs. 81,400</td>\n<td>Rs. 1,54,100</td>\n</tr>\n<tr>\n<td>25</td>\n<td>Rs. 33,900</td>\n<td>Rs. 1,08,300</td>\n<td>Rs. 3,29,200</td>\n<td>Rs. 9,54,000</td>\n</tr>\n</tbody></table>\n<h3>Expected Returns by Investment Type</h3>\n<ul>\n<li><strong>5%:</strong> Savings bank account </li>\n<li><strong>10%:</strong> One-year company fixed deposit </li>\n<li><strong>15-20%+:</strong> Mutual funds or equity shares</li>\n</ul>\n<hr>\n<h2><strong>Time Value of Money</strong></h2>\n<h3>Core Concept</h3>\n<p><strong>&quot;A rupee now is worth more than a rupee in the future&quot;</strong> </p>\n<h3>Reasons</h3>\n<ul>\n<li>Rupee received now can <strong>earn interest in future</strong> </li>\n<li>Amount invested today has <strong>more value</strong> than same amount invested later </li>\n<li>Can utilize the <strong>power of compounding</strong></li>\n</ul>\n<h3>Illustration: Two Options</h3>\n<p><strong>Option A:</strong> Receive Rs. 10,000 now<br><strong>Option B:</strong> Receive Rs. 10,000 after 3 years</p>\n<p><strong>Timeline:</strong></p>\n<pre><code>Year:           0         1         2         3\nOption A:   Rs.10,000 -----&gt; Rs.10,000 + Interest\nOption B:                                  Rs.10,000\n</code></pre>\n<p><strong>Rational choice:</strong> Option A (receive money now and invest it) </p>\n<h3>Future Value Calculation (1 Year)</h3>\n<div class=\"formula-block-iframe\">$ S = P(r + 1) $</div> \n\n<p><strong>Example:</strong> Rs. 10,000 at 5% simple interest for 1 year</p>\n<ul>\n<li>$ S = 10,000 \\times (0.05 + 1) = \\text{Rs. } 10,500 $</li>\n</ul>\n<p>Where:</p>\n<ul>\n<li>$ S $ = Amount received at end of period</li>\n<li>$ P $ = Principal amount</li>\n<li>$ r $ = Interest rate (per year)</li>\n</ul>\n<hr>\n<h2><strong>Time Value of Money Computation</strong></h2>\n<h3>Four Circumstances</h3>\n<h4><strong>1. Future Value of Single Cash Flow</strong></h4>\n<p><strong>Discrete Compounding:</strong></p>\n<div class=\"formula-block-iframe\">$ FV = PV(1 + r)^t $</div> \n\n<p><strong>Continuous Compounding:</strong></p>\n<div class=\"formula-block-iframe\">$ FV = PV \\times e^{rt} $</div> \n\n<p>Where $ e = 2.7183 $ (exponential function)</p>\n<p><strong>Example:</strong> Rs. 2,000 deposit for 3 years at 10%</p>\n<ul>\n<li><strong>Discrete:</strong> $ FV = 2,000 \\times (1.1)^3 = 2,000 \\times 1.331 = \\text{Rs. } 2,662 $</li>\n<li><strong>Continuous:</strong> $ FV = 2,000 \\times e^{(0.10 \\times 3)} = 2,000 \\times 1.349862 = \\text{Rs. } 2,699.72 $</li>\n</ul>\n<h4><strong>2. Future Value of Annuity</strong></h4>\n<p><strong>Definition:</strong> Annuity is a stream of <strong>equal annual cash flows</strong> </p>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ FVA = CF \\times \\frac{(1 + r)^t - 1}{r} $</div> \n\n<p><strong>FVIFA:</strong> Future Value Interest Factor for an Annuity = $ \\frac{(1 + r)^t - 1}{r} $ </p>\n<p><strong>Example:</strong> Rs. 3,000 deposited annually for 5 years at 10%</p>\n<ul>\n<li>$ FVA = 3,000 \\times (1.10)^4 + 3,000 \\times (1.10)^3 + 3,000 \\times (1.10)^2 + 3,000 \\times (1.10) + 3,000 $</li>\n<li>$ = 3,000(1.4641 + 1.3310 + 1.2100 + 1.10 + 1) $</li>\n<li>$ = \\text{Rs. } 18,315.30 $</li>\n</ul>\n<h4><strong>3. Present Value of Single Cash Flow</strong></h4>\n<p><strong>Discrete Discounting:</strong></p>\n<div class=\"formula-block-iframe\">$ PV = \\frac{FV}{(1 + r)^t} $</div> \n\n<p><strong>Example:</strong> Rs. 5,000 payable after 3 years at 10%</p>\n<ul>\n<li>$ PV = \\frac{5,000}{(1.10)^3} = \\text{Rs. } 3,756.57 $</li>\n</ul>\n<p><strong>Continuous Discounting:</strong></p>\n<div class=\"formula-block-iframe\">$ PV = FV \\times e^{-rt} $</div> \n\n<p><strong>Example:</strong> Rs. 10,000 receivable after 2 years at 10%</p>\n<ul>\n<li>$ PV = \\frac{10,000}{e^{(0.1 \\times 2)}} = \\text{Rs. } 8,187.297 $</li>\n</ul>\n<h4><strong>4. Present Value of Annuity</strong></h4>\n<p><strong>Discrete Discounting:</strong></p>\n<div class=\"formula-block-iframe\">$ PVA = FV \\times \\frac{(1 + r)^t - 1}{r \\times (1 + r)^t} $</div> \n\n<p><strong>PVIFA:</strong> Present Value Interest Factor for an Annuity = $ \\frac{(1 + r)^t - 1}{r \\times (1 + r)^t} $ </p>\n<p><strong>Continuous Discounting:</strong></p>\n<div class=\"formula-block-iframe\">$ PV = FV \\times \\frac{(1 - e^{-rt})}{r} $</div> \n\n<p><strong>Example:</strong> Rs. 2,000 received at end of each year for 3 years</p>\n<ul>\n<li>$ PV = 2,000 \\times \\frac{1}{1.10} + 2,000 \\times \\frac{1}{(1.10)^2} + 2,000 \\times \\frac{1}{(1.10)^3} $</li>\n<li>$ = 2,000(0.9091 + 0.8264 + 0.7513) $</li>\n<li>$ = 1,818.18 + 1,652.89 + 1,502.63 $</li>\n<li>$ = \\text{Rs. } 4,973.70 $</li>\n</ul>\n<hr>\n<h2><strong>Effective Annual Return</strong></h2>\n<h3>Difference: Stated vs Effective Return</h3>\n<ul>\n<li><strong>Stated annual return:</strong> Does NOT account for intra-year compounding </li>\n<li><strong>Effective annual return:</strong> Accounts for intra-year compounding</li>\n</ul>\n<h3>Example: Quarterly Compounding at 10%</h3>\n<p><strong>Given:</strong> Rs. 1,000 at 10% per annum, quarterly compounding </p>\n<p><strong>Calculation by Quarter:</strong></p>\n<ul>\n<li><strong>Q1:</strong> Rs. 1,000 → Rs. 1,025</li>\n<li><strong>Q2:</strong> Rs. 1,025 + Rs. 25 + Rs. 0.63 = Rs. 1,050.63</li>\n<li><strong>By end of year:</strong> Rs. 1,103.80</li>\n</ul>\n<p><strong>Result:</strong></p>\n<ul>\n<li><strong>Stated return:</strong> 10%</li>\n<li><strong>Effective return:</strong> 10.38%</li>\n<li><strong>Difference:</strong> 0.38% (significant on large amounts - Rs. 380 on Rs. 1,00,000!)</li>\n</ul>\n<p><strong>Key Point:</strong> Frequency of compounding (quarterly, monthly, daily) affects effective rate of return </p>\n<hr>\n<h2><strong>Company Analysis Framework</strong></h2>\n<h3>Three Types of Analysis</h3>\n<h4><strong>1. Industry Analysis</strong></h4>\n<p><strong>Definition:</strong> Analysis of the industry/sector to which company belongs </p>\n<p><strong>Key Considerations:</strong></p>\n<ul>\n<li>Effect of <strong>Government policy</strong> </li>\n<li><strong>Future demand</strong> of products </li>\n<li><strong>Business environment</strong> alterations </li>\n<li>Impact on competitors in same sector</li>\n</ul>\n<p><strong>Example:</strong> Power Sector companies - NHPC Ltd., NTPC Ltd., Tata Power Company Ltd. </p>\n<h4><strong>2. Corporate Analysis</strong></h4>\n<p><strong>Definition:</strong> Analysis of company&#39;s past performance and future potential </p>\n<p><strong>Key Considerations:</strong></p>\n<ul>\n<li><strong>Current operations</strong> </li>\n<li><strong>Managerial capabilities</strong> </li>\n<li><strong>Growth plans</strong> </li>\n<li><strong>Past performance</strong> vis-à-vis competitors</li>\n</ul>\n<h4><strong>3. Financial Analysis</strong></h4>\n<p><strong>Definition:</strong> Analysis to determine if share is a good buy at current price </p>\n<p><strong>Key Parameters:</strong></p>\n<ul>\n<li><strong>Earnings Per Share (EPS)</strong> </li>\n<li><strong>P/E Ratio</strong> </li>\n<li><strong>Current size of equity</strong> </li>\n<li><strong>Estimated future price</strong></li>\n</ul>\n<p><strong>Requires Understanding:</strong></p>\n<ul>\n<li>Balance Sheet </li>\n<li>Profit and Loss Account </li>\n<li>Annual Report</li>\n</ul>\n<hr>\n<h2><strong>Annual Report</strong></h2>\n<h3>Definition</h3>\n<ul>\n<li><strong>Formal financial statement</strong> issued yearly by a corporate </li>\n<li><strong>Best source of information</strong> about financial health of company</li>\n</ul>\n<h3>Contents</h3>\n<p>Annual Report shows: </p>\n<ul>\n<li>Assets</li>\n<li>Liabilities</li>\n<li>Revenues</li>\n<li>Expenses</li>\n<li>Earnings</li>\n<li>Company&#39;s position at close of business year</li>\n<li>Profit performance during the year</li>\n</ul>\n<h3>Distribution</h3>\n<ul>\n<li><strong>Abridged versions:</strong> Sent to shareholders free of cost </li>\n<li><strong>Detailed report:</strong> Sent on request</li>\n</ul>\n<h3>Key Sections to Read Carefully</h3>\n<h4><strong>1. Director&#39;s Report &amp; Chairman&#39;s Statement</strong></h4>\n<ul>\n<li>Related to <strong>current operational performance</strong> </li>\n<li>Related to <strong>future operational performance</strong></li>\n</ul>\n<h4><strong>2. Auditor&#39;s Report</strong></h4>\n<ul>\n<li>Including <strong>Annexure to Auditor&#39;s Report</strong></li>\n</ul>\n<h4><strong>3. Profit and Loss Account</strong></h4>\n<h4><strong>4. Balance Sheet</strong></h4>\n<h4><strong>5. Notes to Accounts</strong></h4>\n<ul>\n<li>Attached to Balance Sheet</li>\n</ul>\n<hr>\n<h2><strong>Balance Sheet</strong></h2>\n<h3>Definition</h3>\n<p><strong>Shows the financial position of company at a particular point of time</strong> </p>\n<h3>Purpose</h3>\n<ul>\n<li>Record showing <strong>sources of funds</strong> and their <strong>application</strong> for creating/building assets </li>\n<li>Drawn on a <strong>specific date</strong> (e.g., 31st March)</li>\n</ul>\n<h3>Two Forms (Companies Act, 1956)</h3>\n<h4><strong>Account Form</strong></h4>\n<p><strong>Liabilities Side:</strong></p>\n<ul>\n<li>Share Capital</li>\n<li>Reserves and Surplus</li>\n<li>Secured Loans</li>\n<li>Unsecured Loans</li>\n<li>Current Liabilities and Provisions</li>\n</ul>\n<p><strong>Assets Side:</strong></p>\n<ul>\n<li>Fixed Assets</li>\n<li>Investments</li>\n<li>Current Assets, Loans and Advances</li>\n<li>Miscellaneous Expenditure</li>\n</ul>\n<h4><strong>Report Form</strong></h4>\n<p><strong>I. Sources of Funds</strong></p>\n<ol>\n<li><strong>Shareholders&#39; Funds</strong><ul>\n<li>(a) Share Capital</li>\n<li>(b) Reserves &amp; Surplus</li>\n</ul>\n</li>\n<li><strong>Loan Funds</strong><ul>\n<li>(a) Secured Loans</li>\n<li>(b) Unsecured Loans</li>\n</ul>\n</li>\n</ol>\n<p><strong>II. Application of Funds</strong></p>\n<ul>\n<li>(a) Fixed Assets</li>\n<li>(b) Investments</li>\n<li>(c) Current Assets, Loans and Advances<ul>\n<li>Less: Current Liabilities and Provisions</li>\n<li>Net Current Assets</li>\n</ul>\n</li>\n<li>(d) Miscellaneous Expenditure and Losses</li>\n</ul>\n<h3>Fundamental Equation</h3>\n<div class=\"formula-block-iframe\">$ \\text{Total Capital Employed} = \\text{Net Assets} $</div> \n\n<hr>\n<h2><strong>Sources of Funds</strong></h2>\n<h3><strong>1. Shareholders&#39; Fund (Net Worth)</strong></h3>\n<p>Fund coming from <strong>owners of the company</strong> </p>\n<h4><strong>(a) Share Capital</strong></h4>\n<ul>\n<li>Funds contributed by <strong>shareholders</strong> (owners) </li>\n<li>Divided into:<ul>\n<li><strong>Equity Capital:</strong> No fixed dividend rate </li>\n<li><strong>Preference Capital:</strong> Fixed dividend rate</li>\n</ul>\n</li>\n</ul>\n<h4><strong>(b) Reserves and Surplus</strong></h4>\n<ul>\n<li><strong>Retained profits</strong> accumulated over years </li>\n<li>Shareholders&#39; property </li>\n<li>Used for meeting future fund requirements</li>\n</ul>\n<h3><strong>2. Loan Funds</strong></h3>\n<p>Fund <strong>borrowed from outsiders</strong> </p>\n<h4><strong>(a) Secured Loans</strong></h4>\n<p><strong>Definition:</strong> Borrowings <strong>against security</strong> (mortgaging/hypothecating/pledging property) </p>\n<p><strong>Forms:</strong></p>\n<ul>\n<li>Debentures </li>\n<li>Loans from financial institutions </li>\n<li>Loans from commercial banks</li>\n</ul>\n<p><strong>Purpose:</strong> Creates <strong>charge</strong> to safeguard creditors in event of default </p>\n<h4><strong>(b) Unsecured Loans</strong></h4>\n<p><strong>Definition:</strong> Short-term borrowings <strong>without specific security</strong> </p>\n<p><strong>Forms:</strong></p>\n<ul>\n<li>Fixed deposits </li>\n<li>Loans from promoters </li>\n<li>Inter-corporate borrowings </li>\n<li>Unsecured bank loans</li>\n</ul>\n<hr>\n<h2><strong>Types of Share Capital</strong></h2>\n<h3><strong>Equity Shareholders</strong></h3>\n<ul>\n<li><strong>Owners of the company</strong></li>\n<li><strong>Rights:</strong><ul>\n<li>Right to get dividend (as declared)</li>\n<li>Right to vote in Annual General Meeting</li>\n<li>Right to pass resolutions</li>\n</ul>\n</li>\n</ul>\n<h3><strong>Preference Shareholders</strong></h3>\n<ul>\n<li><strong>Preferential Rights:</strong><ul>\n<li>(a) Payment of dividend at <strong>fixed rate</strong> during company&#39;s lifetime</li>\n<li>(b) Return of capital on <strong>winding up</strong> of company</li>\n</ul>\n</li>\n<li><strong>Restrictions:</strong><ul>\n<li>Cannot be traded (unlike equity shares)</li>\n<li>Redeemed after pre-decided period</li>\n<li><strong>No voting rights</strong></li>\n</ul>\n</li>\n</ul>\n<h3>Capital Terminology</h3>\n<table>\n<thead>\n<tr>\n<th><strong>Term</strong></th>\n<th><strong>Definition</strong></th>\n</tr>\n</thead>\n<tbody><tr>\n<td><strong>Authorized Capital</strong></td>\n<td>Maximum capital company is authorized to raise</td>\n</tr>\n<tr>\n<td><strong>Issued Capital</strong></td>\n<td>Part of authorized capital offered for subscription</td>\n</tr>\n<tr>\n<td><strong>Subscribed Capital</strong></td>\n<td>Part of issued capital subscribed (accepted) by public</td>\n</tr>\n<tr>\n<td><strong>Called Up Capital</strong></td>\n<td>Part of subscribed capital called up for payment</td>\n</tr>\n<tr>\n<td><strong>Paid Up Capital</strong></td>\n<td>Part of called up capital actually paid by shareholders</td>\n</tr>\n<tr>\n<td><strong>Calls in Arrears</strong></td>\n<td>Defaulted amount from called up capital</td>\n</tr>\n</tbody></table>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Paid Up Capital} = \\text{Called Up Capital} - \\text{Calls in Arrears} $</div>\n\n<hr>\n<h2><strong>Application of Funds</strong></h2>\n<h3><strong>1. Fixed Assets</strong></h3>\n<p><strong>Characteristics:</strong> </p>\n<ul>\n<li>Acquired for <strong>long-term</strong></li>\n<li>Used for <strong>business operations</strong></li>\n<li><strong>Not meant for resale</strong></li>\n</ul>\n<p><strong>Types:</strong></p>\n<ul>\n<li>Land and buildings</li>\n<li>Plant and machinery</li>\n<li>Patents</li>\n<li>Copyrights</li>\n</ul>\n<h4>Sub-Headings</h4>\n<table>\n<thead>\n<tr>\n<th><strong>Term</strong></th>\n<th><strong>Definition</strong></th>\n</tr>\n</thead>\n<tbody><tr>\n<td><strong>Gross Block</strong></td>\n<td>Total value of acquiring all fixed assets</td>\n</tr>\n<tr>\n<td><strong>Depreciation</strong></td>\n<td>Reduction in asset value due to usage</td>\n</tr>\n<tr>\n<td><strong>Net Block</strong></td>\n<td>Worth of fixed assets after depreciation</td>\n</tr>\n<tr>\n<td><strong>Capital Work in Progress</strong></td>\n<td>Funds for plant under erection/machine yet to be commissioned</td>\n</tr>\n</tbody></table>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Net Block} = \\text{Gross Block} - \\text{Depreciation} $</div>\n\n<h4>Depreciation Methods (Companies Act 1956)</h4>\n<ul>\n<li><strong>Straight Line Method:</strong> Constant annual depreciation</li>\n<li><strong>Written Down Value Method:</strong> Depreciation rate decreases over time</li>\n</ul>\n<h3><strong>2. Investments</strong></h3>\n<ul>\n<li>Financial securities created by investing <strong>surplus funds</strong> </li>\n<li>For getting income (<strong>long-term or short-term</strong>) </li>\n<li><strong>Not from business operations</strong></li>\n</ul>\n<h3><strong>3. Current Assets, Loans, and Advances</strong></h3>\n<p><strong>Definition:</strong> Cash and resources convertible to cash during business operation </p>\n<p><strong>Held for:</strong> Short-term period for day-to-day operational expenditure </p>\n<p><strong>Forms:</strong></p>\n<ul>\n<li>Raw materials </li>\n<li>Finished goods</li>\n<li>Cash</li>\n<li>Debtors</li>\n<li>Inventories</li>\n<li>Loans and advances</li>\n<li>Pre-paid expenses</li>\n</ul>\n<h3><strong>4. Miscellaneous Expenditures and Losses</strong></h3>\n<ul>\n<li>Preliminary expenses not written off </li>\n<li>Pre-operative expenses not written off </li>\n<li>Shown separately on <strong>assets side</strong> of balance sheet</li>\n</ul>\n<hr>\n<h2><strong>Current Liabilities and Provisions</strong></h2>\n<h3><strong>Current Liabilities</strong></h3>\n<p><strong>Definition:</strong> Liability to pay though payment is <strong>deferred</strong> </p>\n<p><strong>Examples:</strong></p>\n<ul>\n<li>Raw materials/goods/services brought on <strong>credit</strong> </li>\n<li>Advances from customers</li>\n</ul>\n<h3><strong>Provisions</strong></h3>\n<p><strong>Definition:</strong> Expenses not required to be paid <strong>immediately</strong> </p>\n<p><strong>Examples:</strong></p>\n<ul>\n<li>Dividend to shareholders </li>\n<li>Payment of tax</li>\n<li>Gratuity</li>\n<li>Pensions</li>\n</ul>\n<h3><strong>Net Current Assets (Net Working Capital)</strong></h3>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Net Current Assets} = \\text{Current Assets} - (\\text{Current Liabilities} + \\text{Provisions}) $</div>\n\n\n<p><strong>Purpose:</strong> Funds required for daily operations after deferring some payments </p>\n<hr>\n<h2><strong>Profit and Loss Account</strong></h2>\n<h3>Definition</h3>\n<p><strong>Shows financial performance of company over a period of time</strong> </p>\n<h3>Key Features</h3>\n<ul>\n<li>Indicates <strong>revenues and expenses</strong> during accounting period </li>\n<li>Accounting period: <strong>April to March</strong> (1 year) </li>\n<li>Shows <strong>net income</strong> (revenue items - expense items)</li>\n</ul>\n<h3>Structure</h3>\n<h4><strong>Income Section</strong></h4>\n<ol>\n<li>Sale of products and other income</li>\n</ol>\n<h4><strong>Expenditure Section</strong></h4>\n<ol start=\"2\">\n<li>Manufacturing and other expenses </li>\n<li>Depreciation </li>\n<li>Interest </li>\n<li>Expenditure transferred to Capital Accounts </li>\n<li>Total Expenditure</li>\n</ol>\n<h4><strong>Profit Calculation</strong></h4>\n<ol start=\"7\">\n<li><strong>Profit Before Tax</strong> = Income - Total Expenditure </li>\n<li>Tax for the year</li>\n<li><strong>Profit After Tax</strong></li>\n</ol>\n<h4><strong>Adjustments</strong></h4>\n<ol start=\"10\">\n<li>Investment allowance Reserve Account </li>\n<li>Investment allowance (Utilized) Reserve written back</li>\n<li>Debenture redemption Reserve</li>\n<li>Capital redemption Reserve</li>\n<li>Balance brought forward from previous year</li>\n</ol>\n<h4><strong>Amount Available for Appropriations</strong></h4>\n<h4><strong>Appropriations</strong></h4>\n<ul>\n<li>(a) Proposed Dividends </li>\n<li>(b) General Reserve</li>\n<li>(c) Balance credited to Balance Sheet</li>\n</ul>\n<hr>\n<h2><strong>Analyzing Profit and Loss Account</strong></h2>\n<h3>Key Checkpoints</h3>\n<h4><strong>1. Sales and Profits Improvement</strong></h4>\n<ul>\n<li>Check <strong>overall improvement</strong> of sales and profits </li>\n<li>Compare: Operating, Gross, and Net profits</li>\n<li>Compare with <strong>previous year</strong> (half-yearly or annual) </li>\n<li><strong>Good sign:</strong> Operational management is efficient</li>\n</ul>\n<h4><strong>2. Other Income Scrutiny</strong></h4>\n<p><strong>Steady Income (Good):</strong> </p>\n<ul>\n<li>Dividend on investments</li>\n<li>Interest from loans and advances</li>\n</ul>\n<p><strong>Non-Recurring Income (Be Cautious):</strong> </p>\n<ul>\n<li>Selling assets</li>\n<li>Selling land</li>\n</ul>\n<h4><strong>3. Expenditure Items Analysis</strong></h4>\n<p><strong>Check increase in:</strong> </p>\n<ul>\n<li>Raw material consumption</li>\n<li>Manpower cost</li>\n<li>Manufacturing expenses</li>\n<li>Administrative expenses</li>\n<li>Selling expenses</li>\n</ul>\n<p><strong>Comparison:</strong></p>\n<ul>\n<li>If cost increases <strong>&gt; sales increase:</strong> Operating conditions not conducive </li>\n<li>If ratio of costs to sales <strong>contained:</strong> Company operations efficient</li>\n</ul>\n<h4><strong>4. Operational Profitability</strong></h4>\n<ul>\n<li>Calculate profits <strong>after ignoring all other income except sales</strong> </li>\n<li><strong>Positive result:</strong> Company is operationally profitable (healthy sign)</li>\n</ul>\n<h4><strong>5. Depreciation Analysis</strong></h4>\n<ul>\n<li>Check for <strong>abnormal increase</strong> </li>\n<li>High depreciation indicates <strong>higher addition of fixed assets</strong> </li>\n<li>Good for <strong>long-term operations</strong> </li>\n<li>Suppresses net profits but <strong>good for cash flow</strong> </li>\n<li><strong>Recommendation:</strong> Check <strong>cash profits</strong> instead of net profits</li>\n</ul>\n<h4><strong>6. Interest Cost Analysis</strong></h4>\n<ul>\n<li>High interest cost is <strong>cause of concern</strong> </li>\n<li>Increased debt burden <strong>cannot be reduced in short run</strong></li>\n</ul>\n<h4><strong>7. Calculate Key Metrics</strong></h4>\n<ul>\n<li><strong>Earnings Per Share (EPS)</strong> </li>\n<li><strong>Various ratios</strong> </li>\n<li><strong>Half-yearly EPS:</strong> Multiply by 2 for annualized EPS</li>\n</ul>\n<hr>\n<h2><strong>Ratio Analysis</strong></h2>\n<h3><strong>Session 1: Liquidity Ratios</strong></h3>\n<h4>Types</h4>\n<ul>\n<li><strong>Current Ratio</strong></li>\n<li><strong>Acid Test Ratio</strong> (Quick Ratio)</li>\n<li><strong>Turnover Ratio</strong></li>\n<li><strong>Average Collection Period</strong></li>\n</ul>\n<h4>Purpose</h4>\n<ul>\n<li>Needs and importance of ratio calculation </li>\n<li>Ideal ratios identification</li>\n<li>Analysis and interpretation</li>\n</ul>\n<h3><strong>Session 2: Leverage/Capital Structure Ratios</strong></h3>\n<h4>Types</h4>\n<ul>\n<li><strong>Debt-Equity Ratio</strong></li>\n<li><strong>Debt-Total Asset Ratio</strong></li>\n<li><strong>Interest Coverage Ratio</strong></li>\n</ul>\n<h4>Purpose</h4>\n<ul>\n<li>Assess company&#39;s <strong>capital structure</strong> </li>\n<li>Measure <strong>financial risk</strong> </li>\n<li>Determine <strong>solvency</strong></li>\n</ul>\n<h3><strong>Session 3: Profitability Ratios</strong></h3>\n<h4>Types</h4>\n<ul>\n<li><strong>GP Ratio</strong> (Gross Profit Ratio)</li>\n<li><strong>NP Ratio</strong> (Net Profit Ratio)</li>\n<li><strong>Return on Total Assets</strong></li>\n<li><strong>Return on Capital Employed</strong></li>\n<li><strong>Return on Shareholder Equity</strong></li>\n</ul>\n<h4>Purpose</h4>\n<ul>\n<li>Measure company&#39;s <strong>ability to generate profits</strong> </li>\n<li>Compare <strong>efficiency</strong> across periods </li>\n<li>Evaluate <strong>management effectiveness</strong></li>\n</ul>\n<hr>\n<h2><strong>CHAPTER 10: RATIO ANALYSIS</strong></h2>\n<h3><strong>Introduction</strong></h3>\n<h3>Purpose of Ratio Analysis</h3>\n<ul>\n<li><strong>Mere statistics/data</strong> in financial statements do not reveal the true picture of a firm&#39;s financial position </li>\n<li><strong>Properly analyzed and interpreted</strong> financial statements provide valuable insights into firm&#39;s performance </li>\n<li><strong>Ratio Analysis</strong> is the most popular tool for analyzing financial statements</li>\n</ul>\n<hr>\n<h2><strong>Classification of Financial Ratios</strong></h2>\n<p>Financial ratios are broadly classified into <strong>three groups:</strong> </p>\n<ol>\n<li><strong>Liquidity Ratios</strong></li>\n<li><strong>Leverage/Capital Structure Ratios</strong></li>\n<li><strong>Profitability Ratios</strong></li>\n</ol>\n<hr>\n<h2><strong>I. LIQUIDITY RATIOS</strong></h2>\n<h3>Definition</h3>\n<p><strong>Liquidity:</strong> Ability of a firm to meet its financial obligations in the <strong>short-term</strong> (less than a year) </p>\n<h3>Basis</h3>\n<p>Based upon the relationship between <strong>current assets</strong> and <strong>current liabilities</strong> </p>\n<hr>\n<h3><strong>(i) Current Ratio</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Current Ratio} = \\frac{\\text{Current Assets}}{\\text{Current Liabilities}} $</div> \n\n<h4>Purpose</h4>\n<ul>\n<li>Measures the ability of firm to meet its <strong>current liabilities</strong> from current assets</li>\n</ul>\n<h4>Interpretation</h4>\n<ul>\n<li><strong>Higher ratio</strong> = Greater short-term solvency </li>\n<li>Larger amount of rupees available per rupee of liability</li>\n</ul>\n<hr>\n<h3><strong>(ii) Acid-Test Ratio (Quick Ratio)</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Acid-Test Ratio} = \\frac{\\text{Quick Assets}}{\\text{Current Liabilities}} $</div> \n\n<h4>Quick Assets Definition</h4>\n<div class=\"formula-block-iframe\">$ \\text{Quick Assets} = \\text{Current Assets} - (\\text{Inventories} + \\text{Prepaid Expenses}) $</div> \n\n<h4>Purpose</h4>\n<ul>\n<li>Measures firm&#39;s ability to <strong>convert current assets quickly into cash</strong> to meet current liabilities</li>\n</ul>\n<h4>Ideal Ratio</h4>\n<ul>\n<li><strong>1:1 ratio</strong> is considered satisfactory</li>\n</ul>\n<hr>\n<h3><strong>(iii) Turnover Ratios</strong></h3>\n<h4>Definition</h4>\n<ul>\n<li>Measure how <strong>quickly</strong> certain current assets are converted into cash </li>\n<li>Measure how <strong>efficiently</strong> assets are employed by a firm</li>\n</ul>\n<h4>Types of Turnover Ratios</h4>\n<hr>\n<h4><strong>A. Inventory Turnover Ratio</strong></h4>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Inventory Turnover Ratio} = \\frac{\\text{Cost of Goods Sold}}{\\text{Average Inventory}} $</div> \n\n<p><strong>Where:</strong></p>\n<ul>\n<li><strong>Cost of Goods Sold</strong> = Sales - Gross Profit </li>\n<li><strong>Average Inventory</strong> = Simple average of opening and closing inventory</li>\n</ul>\n<p><strong>Purpose:</strong></p>\n<ul>\n<li>Tells the <strong>efficiency of inventory management</strong></li>\n</ul>\n<p><strong>Interpretation:</strong></p>\n<ul>\n<li><strong>Higher ratio</strong> = More efficient inventory management</li>\n</ul>\n<hr>\n<h4><strong>B. Debtors&#39; Turnover Ratio</strong></h4>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Debtors' Turnover Ratio} = \\frac{\\text{Net Credit Sales}}{\\text{Average Accounts Receivable (Debtors)}} $</div> \n\n<p><strong>Purpose:</strong></p>\n<ul>\n<li>Shows how many times <strong>accounts receivable turn over</strong> during the year</li>\n</ul>\n<p><strong>Note:</strong></p>\n<ul>\n<li>If net credit sales figure is not available, use <strong>net sales</strong> figure</li>\n</ul>\n<p><strong>Interpretation:</strong></p>\n<ul>\n<li><strong>Higher ratio</strong> = Greater efficiency of credit management</li>\n</ul>\n<hr>\n<h4><strong>C. Average Collection Period</strong></h4>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Average Collection Period} = \\frac{\\text{Average Debtors}}{\\text{Average Daily Credit Sales}} $</div> \n\n<p><strong>Purpose:</strong></p>\n<ul>\n<li>Represents number of <strong>days&#39; worth credit sales</strong> locked in debtors (accounts receivable)</li>\n</ul>\n<p><strong>Relationship with Debtors Turnover:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Average Collection Period} = \\frac{365 \\text{ Days}}{\\text{Debtors Turnover}} $</div> \n\n<hr>\n<h4><strong>D. Fixed Assets Turnover Ratio</strong></h4>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Fixed Assets Turnover Ratio} = \\frac{\\text{Net Sales}}{\\text{Net Fixed Assets}} $</div> \n\n<p><strong>Purpose:</strong></p>\n<ul>\n<li>Measures <strong>sales per rupee</strong> of investment in fixed assets </li>\n<li>Shows how efficiently <strong>fixed assets are employed</strong></li>\n</ul>\n<p><strong>Interpretation:</strong></p>\n<ul>\n<li><strong>Higher ratio</strong> is preferred</li>\n</ul>\n<hr>\n<h4><strong>E. Total Assets Turnover Ratio</strong></h4>\n<p><strong>Formula:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Total Assets Turnover Ratio} = \\frac{\\text{Net Sales}}{\\text{Average Total Assets}} $</div> \n\n<p><strong>Purpose:</strong></p>\n<ul>\n<li>Measures how efficiently <strong>all types of assets</strong> are employed</li>\n</ul>\n<hr>\n<h2><strong>II. LEVERAGE/CAPITAL STRUCTURE RATIOS</strong></h2>\n<h3>Definition</h3>\n<ul>\n<li>Measure <strong>long-term financial strength or soundness</strong> of a firm </li>\n<li>Assess firm&#39;s ability to:<ul>\n<li>Pay interest regularly </li>\n<li>Repay principal on due dates or at maturity</li>\n</ul>\n</li>\n</ul>\n<h3>Two Sets of Ratios</h3>\n<h4><strong>Set 1: Balance Sheet Ratios</strong></h4>\n<ul>\n<li>Based on relationship between <strong>borrowed funds</strong> and <strong>owner&#39;s capital</strong> </li>\n<li>Computed from Balance Sheet</li>\n</ul>\n<h4><strong>Set 2: Coverage Ratios</strong></h4>\n<ul>\n<li>Calculated from <strong>Profit and Loss Account</strong> </li>\n<li>Measure relationship between <strong>proceeds from operations</strong> and <strong>claims of outsiders</strong></li>\n</ul>\n<hr>\n<h3><strong>(i) Debt-Equity Ratio</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Debt-Equity Ratio} = \\frac{\\text{Total Debt}}{\\text{Total Equity}} $</div> \n\n<h4>Purpose</h4>\n<ul>\n<li>Reflects <strong>relative contributions</strong> of creditors and owners to finance the business</li>\n</ul>\n<h4>Ideal Ratio</h4>\n<ul>\n<li>Desirable proportion (high or low) <strong>varies from industry to industry</strong></li>\n</ul>\n<hr>\n<h3><strong>(ii) Debt-Asset Ratio</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Debt-Asset Ratio} = \\frac{\\text{Total Debt}}{\\text{Total Assets}} $</div> \n\n<h4>Components</h4>\n<ul>\n<li><strong>Total Debt</strong> = Long-term debt + Current liabilities </li>\n<li><strong>Total Assets</strong> = Permanent capital + Current liabilities</li>\n</ul>\n<hr>\n<h3><strong>(iii) Interest Coverage Ratio</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Interest Coverage Ratio} = \\frac{\\text{Earnings Before Interest and Taxes (EBIT)}}{\\text{Interest}} $</div> \n\n<h4>Interpretation</h4>\n<ul>\n<li><strong>Higher ratio</strong> = Better firm&#39;s ability to meet its interest burden</li>\n</ul>\n<h4>Usage</h4>\n<ul>\n<li><strong>Lenders</strong> use this ratio to assess <strong>debt servicing capacity</strong> of a firm</li>\n</ul>\n<hr>\n<h3><strong>(iv) Debt Service Coverage Ratio (DSCR)</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{DSCR} = \\frac{\\text{PAT} + \\text{Depreciation} + \\text{Other Non-cash Expenditure} + \\text{Interest on Term Loan}}{\\text{Interest on Term Loan} + \\text{Repayment of Term Loan}} $</div> \n\n<p>Where:</p>\n<ul>\n<li><strong>PAT</strong> = Profit After Tax</li>\n</ul>\n<h4>Purpose</h4>\n<ul>\n<li><strong>More comprehensive and apt</strong> to compute debt service capacity of a firm </li>\n<li>Financial institutions calculate <strong>average DSCR</strong> for period during which term loan is repayable</li>\n</ul>\n<hr>\n<h2><strong>III. PROFITABILITY RATIOS</strong></h2>\n<h3>Definition</h3>\n<ul>\n<li>Judge <strong>profitability</strong> and <strong>operating/management efficiency</strong> of a firm</li>\n</ul>\n<hr>\n<h3><strong>(i) Gross Profit Ratio (%)</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Gross Profit Ratio (\\%)} = \\frac{\\text{Gross Profit}}{\\text{Net Sales}} \\times 100 $</div> \n\n<hr>\n<h3><strong>(ii) Net Profit Ratio (%)</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Net Profit Ratio (\\%)} = \\frac{\\text{Net Profit}}{\\text{Net Sales}} \\times 100 $</div> \n\n<hr>\n<h3><strong>Profitability Ratios Related to Investments</strong></h3>\n<hr>\n<h3><strong>(iii) Return on Total Assets</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Return on Total Assets} = \\frac{\\text{Profit Before Interest and Tax}}{\\text{Fixed Assets} + \\text{Current Assets}} $</div> \n\n<hr>\n<h3><strong>(iv) Return on Capital Employed</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Return on Capital Employed} = \\frac{\\text{Net Profit After Tax}}{\\text{Total Capital Employed}} $</div> \n\n<p><strong>Where:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Total Capital Employed} = \\text{Total Fixed Assets} + \\text{Current Assets} - \\text{Current Liabilities} $</div> \n\n<hr>\n<h3><strong>(v) Return on Shareholders&#39; Equity</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{Return on Shareholders' Equity} = \\frac{\\text{Net Profit After Tax}}{\\text{Average Total Shareholders' Equity or Net Worth}} $</div> \n\n<p><strong>Where:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Net Worth} = \\text{Shareholders' Equity Capital} + \\text{Reserves and Surplus} $</div> \n\n<h4>Concept</h4>\n<ul>\n<li><strong>Equity shareholder</strong> has only a <strong>residual claim</strong> on profits and assets </li>\n<li>Distribution only after claims of creditors and preference shareholders are met </li>\n<li><strong>Return on Equity</strong> reflects measure of shareholder&#39;s well-being</li>\n</ul>\n<hr>\n<h2><strong>STOCK MARKET RELATED RATIOS</strong></h2>\n<h3><strong>(i) Earnings Per Share (EPS)</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{EPS} = \\frac{\\text{Net Profit Available to Shareholders}}{\\text{Number of Ordinary Shares Outstanding}} $</div> \n\n<p><strong>Where:</strong></p>\n<div class=\"formula-block-iframe\">$ \\text{Net Profit Available} = \\text{Net Profit After Tax} - \\text{Preference Dividend} $</div> \n\n<h4>Purpose</h4>\n<ul>\n<li>Measures <strong>profit available to equity shareholders per share</strong> </li>\n<li>Amount shareholders can get on <strong>every share held</strong> </li>\n<li>Indicates the <strong>value of equity in the market</strong></li>\n</ul>\n<hr>\n<h3><strong>(ii) Price-Earnings Ratio (P/E Ratio)</strong></h3>\n<h4>Formula</h4>\n<div class=\"formula-block-iframe\">$ \\text{P/E Ratio} = \\frac{\\text{Market Price per Share}}{\\text{EPS}} $</div> \n\n<hr>\n<h2><strong>PRACTICAL ILLUSTRATION</strong></h2>\n<h3><strong>ABC Co. Ltd. - Balance Sheet as on March 31, 2005</strong></h3>\n<p><strong>(Rs. in Crore)</strong> </p>\n<table>\n<thead>\n<tr>\n<th><strong>Liabilities</strong></th>\n<th><strong>Amount</strong></th>\n<th><strong>Assets</strong></th>\n<th><strong>Amount</strong></th>\n</tr>\n</thead>\n<tbody><tr>\n<td><strong>Share Capital</strong></td>\n<td>16.00</td>\n<td><strong>Fixed Assets (net)</strong></td>\n<td>60.00</td>\n</tr>\n<tr>\n<td>(1,00,00,000 equity shares of Rs.10 each)</td>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td><strong>Reserves &amp; Surplus</strong></td>\n<td>22.00</td>\n<td><strong>Current Assets:</strong></td>\n<td>23.40</td>\n</tr>\n<tr>\n<td><strong>Secured Loans</strong></td>\n<td>21.00</td>\n<td>- Cash &amp; Bank</td>\n<td>0.20</td>\n</tr>\n<tr>\n<td><strong>Unsecured Loans</strong></td>\n<td>25.00</td>\n<td>- Debtors</td>\n<td>11.80</td>\n</tr>\n<tr>\n<td><strong>Current Liabilities &amp; Provisions</strong></td>\n<td>16.00</td>\n<td>- Inventories</td>\n<td>10.60</td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td>- Pre-paid expenses</td>\n<td>0.80</td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td><strong>Investments</strong></td>\n<td>16.60</td>\n</tr>\n<tr>\n<td><strong>Total</strong></td>\n<td><strong>100.00</strong></td>\n<td><strong>Total</strong></td>\n<td><strong>100.00</strong></td>\n</tr>\n</tbody></table>\n<hr>\n<h3><strong>ABC Co. Ltd. - Profit &amp; Loss Account for Year Ending March 31, 2005</strong></h3>\n<table>\n<thead>\n<tr>\n<th><strong>Particulars</strong></th>\n<th><strong>Amount</strong></th>\n<th><strong>Particulars</strong></th>\n<th><strong>Amount</strong></th>\n</tr>\n</thead>\n<tbody><tr>\n<td>Opening Stock</td>\n<td>13.00</td>\n<td>Sales (net)</td>\n<td>105.00</td>\n</tr>\n<tr>\n<td>Purchases</td>\n<td>69.00</td>\n<td>Closing Stock</td>\n<td>15.00</td>\n</tr>\n<tr>\n<td>Wages and Salaries</td>\n<td>12.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Other Mfg. Expenses</td>\n<td>10.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Gross Profit</td>\n<td>16.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td><strong>Total</strong></td>\n<td><strong>120.00</strong></td>\n<td><strong>Total</strong></td>\n<td><strong>120.00</strong></td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Administrative &amp; Personnel Expenses</td>\n<td>1.50</td>\n<td>Gross Profit</td>\n<td>16.00</td>\n</tr>\n<tr>\n<td>Selling &amp; Distribution Expenses</td>\n<td>2.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Depreciation</td>\n<td>2.50</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Interest</td>\n<td>1.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Net Profit</td>\n<td>9.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td><strong>Total</strong></td>\n<td><strong>16.00</strong></td>\n<td><strong>Total</strong></td>\n<td><strong>16.00</strong></td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Income Tax</td>\n<td>4.00</td>\n<td>Net Profit</td>\n<td>9.00</td>\n</tr>\n<tr>\n<td>Equity Dividend</td>\n<td>3.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td>Retained Earnings</td>\n<td>2.00</td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td><strong>Total</strong></td>\n<td><strong>9.00</strong></td>\n<td><strong>Total</strong></td>\n<td><strong>9.00</strong></td>\n</tr>\n</tbody></table>\n<p><strong>Market Price per Equity Share = Rs. 20.00</strong> </p>\n<hr>\n<h2><strong>CALCULATED RATIOS FOR ABC CO. LTD.</strong></h2>\n<h3><strong>1. Current Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Current Ratio} = \\frac{23.40}{16.00} = \\mathbf{1.46} $</div> \n\n<hr>\n<h3><strong>2. Quick Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Quick Ratio} = \\frac{23.40 - (10.60 + 0.80)}{16.00} = \\frac{12.00}{16.00} = \\mathbf{0.75} $</div> \n\n<hr>\n<h3><strong>3. Inventory Turnover Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Cost of Goods Sold} = 105 - 16 = 89 $</div>\n<div class=\"formula-block-iframe\">$ \\text{Average Inventory} = \\frac{15 + 13}{2} = 14 $</div>\n<div class=\"formula-block-iframe\">$ \\text{Inventory Turnover} = \\frac{89}{14} = \\mathbf{6.36} $</div> \n\n<hr>\n<h3><strong>4. Debtors Turnover Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Debtors Turnover} = \\frac{105}{11.80} = \\mathbf{8.8983} $</div> \n\n<hr>\n<h3><strong>5. Average Collection Period</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Average Collection Period} = \\frac{365}{8.8983} = \\mathbf{41 \\text{ days}} $</div> \n\n<hr>\n<h3><strong>6. Fixed Assets Turnover Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Fixed Assets Turnover} = \\frac{105}{60} = \\mathbf{1.75} $</div> \n\n<hr>\n<h3><strong>7. Debt to Equity Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Debt} = 21.00 + 25.00 = 46.00 $</div>\n<div class=\"formula-block-iframe\">$ \\text{Equity} = 16.00 + 22.00 = 38.00 $</div>\n<div class=\"formula-block-iframe\">$ \\text{Debt-Equity Ratio} = \\frac{46}{38} = \\mathbf{1.21} $</div> \n\n<hr>\n<h3><strong>8. Gross Profit Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Gross Profit Ratio} = \\frac{16.00}{105.00} = 0.15238 = \\mathbf{15.24\\%} $</div> \n\n<hr>\n<h3><strong>9. Net Profit Ratio</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Net Profit Ratio} = \\frac{9}{105.00} = 0.0857 = \\mathbf{8.57\\%} $</div> \n\n<hr>\n<h3><strong>10. Return on Shareholders&#39; Equity</strong></h3>\n<div class=\"formula-block-iframe\">$ \\text{Net Profit After Tax} = 9 - 4 = 5.00 $</div>\n<div class=\"formula-block-iframe\">$ \\text{Net Worth} = 16.00 + 22.00 = 38.00 $</div>\n<div class=\"formula-block-iframe\">$ \\text{Return on Equity} = \\frac{5.00}{38.00} = 0.13157 = \\mathbf{13.16\\%} $</div> \n\n<hr>\n<h2><strong>SUMMARY TABLE: ALL RATIOS AT A GLANCE</strong></h2>\n<table>\n<thead>\n<tr>\n<th><strong>Category</strong></th>\n<th><strong>Ratio</strong></th>\n<th><strong>Formula</strong></th>\n<th><strong>ABC Co. Result</strong></th>\n</tr>\n</thead>\n<tbody><tr>\n<td><strong>Liquidity</strong></td>\n<td>Current Ratio</td>\n<td>$ \\frac{\\text{Current Assets}}{\\text{Current Liabilities}} $</td>\n<td>1.46</td>\n</tr>\n<tr>\n<td></td>\n<td>Quick Ratio</td>\n<td>$ \\frac{\\text{Quick Assets}}{\\text{Current Liabilities}} $</td>\n<td>0.75</td>\n</tr>\n<tr>\n<td></td>\n<td>Inventory Turnover</td>\n<td>$ \\frac{\\text{COGS}}{\\text{Avg Inventory}} $</td>\n<td>6.36</td>\n</tr>\n<tr>\n<td></td>\n<td>Debtors Turnover</td>\n<td>$ \\frac{\\text{Net Credit Sales}}{\\text{Avg Debtors}} $</td>\n<td>8.90</td>\n</tr>\n<tr>\n<td></td>\n<td>Avg Collection Period</td>\n<td>$ \\frac{365}{\\text{Debtors Turnover}} $</td>\n<td>41 days</td>\n</tr>\n<tr>\n<td></td>\n<td>Fixed Assets Turnover</td>\n<td>$ \\frac{\\text{Net Sales}}{\\text{Net Fixed Assets}} $</td>\n<td>1.75</td>\n</tr>\n<tr>\n<td></td>\n<td>Total Assets Turnover</td>\n<td>$ \\frac{\\text{Net Sales}}{\\text{Avg Total Assets}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td><strong>Leverage</strong></td>\n<td>Debt-Equity Ratio</td>\n<td>$ \\frac{\\text{Total Debt}}{\\text{Total Equity}} $</td>\n<td>1.21</td>\n</tr>\n<tr>\n<td></td>\n<td>Debt-Asset Ratio</td>\n<td>$ \\frac{\\text{Total Debt}}{\\text{Total Assets}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td></td>\n<td>Interest Coverage</td>\n<td>$ \\frac{\\text{EBIT}}{\\text{Interest}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td></td>\n<td>DSCR</td>\n<td>$ \\frac{\\text{PAT+Dep+Interest}}{\\text{Interest+Repayment}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td><strong>Profitability</strong></td>\n<td>Gross Profit Ratio</td>\n<td>$ \\frac{\\text{Gross Profit}}{\\text{Net Sales}} \\times 100 $</td>\n<td>15.24%</td>\n</tr>\n<tr>\n<td></td>\n<td>Net Profit Ratio</td>\n<td>$ \\frac{\\text{Net Profit}}{\\text{Net Sales}} \\times 100 $</td>\n<td>8.57%</td>\n</tr>\n<tr>\n<td></td>\n<td>Return on Total Assets</td>\n<td>$ \\frac{\\text{PBIT}}{\\text{Fixed+Current Assets}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td></td>\n<td>Return on Capital Employed</td>\n<td>$ \\frac{\\text{PAT}}{\\text{Total Capital Employed}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td></td>\n<td>Return on Equity</td>\n<td>$ \\frac{\\text{PAT}}{\\text{Net Worth}} $</td>\n<td>13.16%</td>\n</tr>\n<tr>\n<td><strong>Market</strong></td>\n<td>EPS</td>\n<td>$ \\frac{\\text{PAT-Pref Div}}{\\text{No. of Shares}} $</td>\n<td>-</td>\n</tr>\n<tr>\n<td></td>\n<td>P/E Ratio</td>\n<td>$ \\frac{\\text{Market Price}}{\\text{EPS}} $</td>\n<td>-</td>\n</tr>\n</tbody></table>\n<hr>\n<h2><strong>KEY ABBREVIATIONS</strong></h2>\n<h3>Exchanges &amp; Organizations</h3>\n<ul>\n<li><strong>NSE</strong> - National Stock Exchange of India Ltd.</li>\n<li><strong>SEBI</strong> - Securities Exchange Board of India</li>\n<li><strong>NSDL</strong> - National Securities Depository Limited</li>\n<li><strong>CDSL</strong> - Central Depository Services (India) Limited</li>\n<li><strong>NCDEX</strong> - National Commodity and Derivatives Exchange Ltd.</li>\n<li><strong>NSCCL</strong> - National Securities Clearing Corporation Ltd.</li>\n<li><strong>FMC</strong> - Forward Markets Commission</li>\n<li><strong>NYSE</strong> - New York Stock Exchange</li>\n<li><strong>AMEX</strong> - American Stock Exchange</li>\n</ul>\n<h3>Terms &amp; Ratios</h3>\n<ul>\n<li><strong>EPS</strong> - Earnings Per Share</li>\n<li><strong>DSCR</strong> - Debt Service Coverage Ratio</li>\n<li><strong>NAV</strong> - Net Asset Value</li>\n<li><strong>IPO</strong> - Initial Public Offer</li>\n<li><strong>DP</strong> - Depository Participant</li>\n<li><strong>DRF</strong> - Demat Request Form</li>\n<li><strong>RRF</strong> - Remat Request Form</li>\n<li><strong>OTC</strong> - Over-the-Counter Market</li>\n<li><strong>LM</strong> - Lead Manager</li>\n</ul>\n<h3>Rating Agencies</h3>\n<ul>\n<li><strong>CRISIL</strong> - Credit Rating Information Services of India Limited</li>\n<li><strong>CARE</strong> - Credit Analysis &amp; Research Limited</li>\n<li><strong>ICRA</strong> - Investment Information and Credit Rating Agency of India</li>\n<li><strong>S&amp;P</strong> - Standard &amp; Poor</li>\n<li><strong>IISL</strong> - India Index Services &amp; Products Ltd</li>\n</ul>\n<h3>Acts &amp; Services</h3>\n<ul>\n<li><strong>SCRA</strong> - Securities Contract (Regulation) Act</li>\n<li><strong>SCRR</strong> - Securities Contract (Regulation) Rules</li>\n<li><strong>ISC</strong> - Investor Service Cell</li>\n<li><strong>IPF</strong> - Investor Protection Fund</li>\n<li><strong>NCFM</strong> - NSE&#39;s Certification in Financial Markets</li>\n</ul>\n<hr>\n",
